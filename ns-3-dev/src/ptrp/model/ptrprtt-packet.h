...
enum MessageType
{
  ptrpTYPE_RREQ  = 1,   //!< ptrpTYPE_RREQ
  ptrpTYPE_RREP  = 2,   //!< ptrpTYPE_RREP
  ptrpTYPE_RERR  = 3,   //!< ptrpTYPE_RERR
  ptrpTYPE_RREP_ACK = 4 //!< ptrpTYPE_RREP_ACK
};
...
public:
  /**
   * constructor
   * \param t the ptrp RREQ type
   */
  TypeHeader (MessageType t = ptrpTYPE_RREQ);
...
public:
  ...
  void SetRTTstart(int64_t startStamp);
  int64_t GetRTTstart() const;
