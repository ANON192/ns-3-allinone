 ...
 */
#ifndef ptrp_RQUEUE_H
#define ptrp_RQUEUE_H
...
/**
 * \ingroup ptrp
 * \brief ptrp route request queue
 *
 * Since ptrp is an on demand routing we queue requests while looking for route.
 */
class RequestQueue
{
public:
