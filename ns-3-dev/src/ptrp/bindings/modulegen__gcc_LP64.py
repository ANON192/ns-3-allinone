...
def module_init():
    root_module = Module('ns.ncpr', cpp_namespace='::ns3')
    return root_module
...
def register_types(module):
    ...
    ## ncpr-helper.h (module 'ncpr'): ns3::ncprHelper [class]
    module.add_class('ncprHelper', parent=root_module['ns3::Ipv4RoutingHelper'])
    ...
    ## Register a nested module for the namespace ncpr
    
    nested_module = module.add_cpp_namespace('ncpr')
    register_types_ns3_ncpr(nested_module)
...
def register_types_ns3_ncpr(module):
    root_module = module.get_root()
    
    ## ncpr-rtable.h (module 'ncpr'): ns3::ncpr::RouteFlags [enumeration]
    module.add_enum('RouteFlags', ['VALID', 'INVALID', 'IN_SEARCH'])
    ## ncpr-packet.h (module 'ncpr'): ns3::ncpr::MessageType [enumeration]
    module.add_enum('MessageType', ['ncprTYPE_RREQ', 'ncprTYPE_RREP', 'ncprTYPE_RERR', 'ncprTYPE_RREP_ACK'])
    ## ncpr-dpd.h (module 'ncpr'): ns3::ncpr::DuplicatePacketDetection [class]
    module.add_class('DuplicatePacketDetection')
    ## ncpr-id-cache.h (module 'ncpr'): ns3::ncpr::IdCache [class]
    module.add_class('IdCache')
    ## ncpr-neighbor.h (module 'ncpr'): ns3::ncpr::Neighbors [class]
    module.add_class('Neighbors')
    ## ncpr-neighbor.h (module 'ncpr'): ns3::ncpr::Neighbors::Neighbor [struct]
    module.add_class('Neighbor', outer_class=root_module['ns3::ncpr::Neighbors'])
    ## ncpr-rqueue.h (module 'ncpr'): ns3::ncpr::QueueEntry [class]
    module.add_class('QueueEntry')
    typehandlers.add_type_alias(u'ns3::Ipv4RoutingProtocol::UnicastForwardCallback', u'ns3::ncpr::QueueEntry::UnicastForwardCallback')
    typehandlers.add_type_alias(u'ns3::Ipv4RoutingProtocol::UnicastForwardCallback*', u'ns3::ncpr::QueueEntry::UnicastForwardCallback*')
    typehandlers.add_type_alias(u'ns3::Ipv4RoutingProtocol::UnicastForwardCallback&', u'ns3::ncpr::QueueEntry::UnicastForwardCallback&')
    typehandlers.add_type_alias(u'ns3::Ipv4RoutingProtocol::ErrorCallback', u'ns3::ncpr::QueueEntry::ErrorCallback')
    typehandlers.add_type_alias(u'ns3::Ipv4RoutingProtocol::ErrorCallback*', u'ns3::ncpr::QueueEntry::ErrorCallback*')
    typehandlers.add_type_alias(u'ns3::Ipv4RoutingProtocol::ErrorCallback&', u'ns3::ncpr::QueueEntry::ErrorCallback&')
    ## ncpr-rqueue.h (module 'ncpr'): ns3::ncpr::RequestQueue [class]
    module.add_class('RequestQueue')
    ## ncpr-packet.h (module 'ncpr'): ns3::ncpr::RerrHeader [class]
    module.add_class('RerrHeader', parent=root_module['ns3::Header'])
    ## ncpr-routing-protocol.h (module 'ncpr'): ns3::ncpr::RoutingProtocol [class]
    module.add_class('RoutingProtocol', parent=root_module['ns3::Ipv4RoutingProtocol'])
    ## ncpr-rtable.h (module 'ncpr'): ns3::ncpr::RoutingTable [class]
    module.add_class('RoutingTable')
    ## ncpr-rtable.h (module 'ncpr'): ns3::ncpr::RoutingTableEntry [class]
    module.add_class('RoutingTableEntry')
    ## ncpr-packet.h (module 'ncpr'): ns3::ncpr::RrepAckHeader [class]
    module.add_class('RrepAckHeader', parent=root_module['ns3::Header'])
    ## ncpr-packet.h (module 'ncpr'): ns3::ncpr::RrepHeader [class]
    module.add_class('RrepHeader', parent=root_module['ns3::Header'])
    ## ncpr-packet.h (module 'ncpr'): ns3::ncpr::RreqHeader [class]
    module.add_class('RreqHeader', parent=root_module['ns3::Header'])
    ## ncpr-packet.h (module 'ncpr'): ns3::ncpr::TypeHeader [class]
...
def register_methods(root_module):
    ...
    register_Ns3ncprHelper_methods(root_module, root_module['ns3::ncprHelper'])
    ...
    register_Ns3ncprDuplicatePacketDetection_methods(root_module, root_module['ns3::ncpr::DuplicatePacketDetection'])
    register_Ns3ncprIdCache_methods(root_module, root_module['ns3::ncpr::IdCache'])
    register_Ns3ncprNeighbors_methods(root_module, root_module['ns3::ncpr::Neighbors'])
    register_Ns3ncprNeighborsNeighbor_methods(root_module, root_module['ns3::ncpr::Neighbors::Neighbor'])
    register_Ns3ncprQueueEntry_methods(root_module, root_module['ns3::ncpr::QueueEntry'])
    register_Ns3ncprRequestQueue_methods(root_module, root_module['ns3::ncpr::RequestQueue'])
    register_Ns3ncprRerrHeader_methods(root_module, root_module['ns3::ncpr::RerrHeader'])
    register_Ns3ncprRoutingProtocol_methods(root_module, root_module['ns3::ncpr::RoutingProtocol'])
    register_Ns3ncprRoutingTable_methods(root_module, root_module['ns3::ncpr::RoutingTable'])
    register_Ns3ncprRoutingTableEntry_methods(root_module, root_module['ns3::ncpr::RoutingTableEntry'])
    register_Ns3ncprRrepAckHeader_methods(root_module, root_module['ns3::ncpr::RrepAckHeader'])
    register_Ns3ncprRrepHeader_methods(root_module, root_module['ns3::ncpr::RrepHeader'])
    register_Ns3ncprRreqHeader_methods(root_module, root_module['ns3::ncpr::RreqHeader'])
    register_Ns3ncprTypeHeader_methods(root_module, root_module['ns3::ncpr::TypeHeader'])
    return
...
def register_Ns3ncprHelper_methods(root_module, cls):
    ## ncpr-helper.h (module 'ncpr'): ns3::ncprHelper::ncprHelper(ns3::ncprHelper const & arg0) [constructor]
    cls.add_constructor([param('ns3::ncprHelper const &', 'arg0')])
    ## ncpr-helper.h (module 'ncpr'): ns3::ncprHelper::ncprHelper() [constructor]
    cls.add_constructor([])
    ## ncpr-helper.h (module 'ncpr'): int64_t ns3::ncprHelper::AssignStreams(ns3::NodeContainer c, int64_t stream) [member function]
    cls.add_method('AssignStreams', 
                   'int64_t', 
                   [param('ns3::NodeContainer', 'c'), param('int64_t', 'stream')])
    ## ncpr-helper.h (module 'ncpr'): ns3::ncprHelper * ns3::ncprHelper::Copy() const [member function]
    cls.add_method('Copy', 
                   'ns3::ncprHelper *', 
                   [], 
                   is_const=True, is_virtual=True)
    ## ncpr-helper.h (module 'ncpr'): ns3::Ptr<ns3::Ipv4RoutingProtocol> ns3::ncprHelper::Create(ns3::Ptr<ns3::Node> node) const [member function]
    cls.add_method('Create', 
                   'ns3::Ptr< ns3::Ipv4RoutingProtocol >', 
                   [param('ns3::Ptr< ns3::Node >', 'node')], 
                   is_const=True, is_virtual=True)
    ## ncpr-helper.h (module 'ncpr'): void ns3::ncprHelper::Set(std::string name, ns3::AttributeValue const & value) [member function]
    cls.add_method('Set', 
                   'void', 
                   [param('std::string', 'name'), param('ns3::AttributeValue const &', 'value')])
    return
...
def register_Ns3ncprDuplicatePacketDetection_methods(root_module, cls):
    ## ncpr-dpd.h (module 'ncpr'): ns3::ncpr::DuplicatePacketDetection::DuplicatePacketDetection(ns3::ncpr::DuplicatePacketDetection const & arg0) [constructor]
    cls.add_constructor([param('ns3::ncpr::DuplicatePacketDetection const &', 'arg0')])
    ## ncpr-dpd.h (module 'ncpr'): ns3::ncpr::DuplicatePacketDetection::DuplicatePacketDetection(ns3::Time lifetime) [constructor]
    cls.add_constructor([param('ns3::Time', 'lifetime')])
    ## ncpr-dpd.h (module 'ncpr'): ns3::Time ns3::ncpr::DuplicatePacketDetection::GetLifetime() const [member function]
    cls.add_method('GetLifetime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## ncpr-dpd.h (module 'ncpr'): bool ns3::ncpr::DuplicatePacketDetection::IsDuplicate(ns3::Ptr<const ns3::Packet> p, ns3::Ipv4Header const & header) [member function]
    cls.add_method('IsDuplicate', 
                   'bool', 
                   [param('ns3::Ptr< ns3::Packet const >', 'p'), param('ns3::Ipv4Header const &', 'header')])
    ## ncpr-dpd.h (module 'ncpr'): void ns3::ncpr::DuplicatePacketDetection::SetLifetime(ns3::Time lifetime) [member function]
    cls.add_method('SetLifetime', 
                   'void', 
                   [param('ns3::Time', 'lifetime')])
    return

def register_Ns3ncprIdCache_methods(root_module, cls):
    ## ncpr-id-cache.h (module 'ncpr'): ns3::ncpr::IdCache::IdCache(ns3::ncpr::IdCache const & arg0) [constructor]
    cls.add_constructor([param('ns3::ncpr::IdCache const &', 'arg0')])
    ## ncpr-id-cache.h (module 'ncpr'): ns3::ncpr::IdCache::IdCache(ns3::Time lifetime) [constructor]
    cls.add_constructor([param('ns3::Time', 'lifetime')])
    ## ncpr-id-cache.h (module 'ncpr'): ns3::Time ns3::ncpr::IdCache::GetLifeTime() const [member function]
    cls.add_method('GetLifeTime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## ncpr-id-cache.h (module 'ncpr'): uint32_t ns3::ncpr::IdCache::GetSize() [member function]
    cls.add_method('GetSize', 
                   'uint32_t', 
                   [])
    ## ncpr-id-cache.h (module 'ncpr'): bool ns3::ncpr::IdCache::IsDuplicate(ns3::Ipv4Address addr, uint32_t id) [member function]
    cls.add_method('IsDuplicate', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'addr'), param('uint32_t', 'id')])
    ## ncpr-id-cache.h (module 'ncpr'): void ns3::ncpr::IdCache::Purge() [member function]
    cls.add_method('Purge', 
                   'void', 
                   [])
    ## ncpr-id-cache.h (module 'ncpr'): void ns3::ncpr::IdCache::SetLifetime(ns3::Time lifetime) [member function]
    cls.add_method('SetLifetime', 
                   'void', 
                   [param('ns3::Time', 'lifetime')])
    return

def register_Ns3ncprNeighbors_methods(root_module, cls):
    ## ncpr-neighbor.h (module 'ncpr'): ns3::ncpr::Neighbors::Neighbors(ns3::ncpr::Neighbors const & arg0) [constructor]
    cls.add_constructor([param('ns3::ncpr::Neighbors const &', 'arg0')])
    ## ncpr-neighbor.h (module 'ncpr'): ns3::ncpr::Neighbors::Neighbors(ns3::Time delay) [constructor]
    cls.add_constructor([param('ns3::Time', 'delay')])
    ## ncpr-neighbor.h (module 'ncpr'): void ns3::ncpr::Neighbors::AddArpCache(ns3::Ptr<ns3::ArpCache> a) [member function]
    cls.add_method('AddArpCache', 
                   'void', 
                   [param('ns3::Ptr< ns3::ArpCache >', 'a')])
    ## ncpr-neighbor.h (module 'ncpr'): void ns3::ncpr::Neighbors::Clear() [member function]
    cls.add_method('Clear', 
                   'void', 
                   [])
    ## ncpr-neighbor.h (module 'ncpr'): void ns3::ncpr::Neighbors::DelArpCache(ns3::Ptr<ns3::ArpCache> a) [member function]
    cls.add_method('DelArpCache', 
                   'void', 
                   [param('ns3::Ptr< ns3::ArpCache >', 'a')])
    ## ncpr-neighbor.h (module 'ncpr'): ns3::Callback<void, ns3::Ipv4Address, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty> ns3::ncpr::Neighbors::GetCallback() const [member function]
    cls.add_method('GetCallback', 
                   ...
                   [], 
                   is_const=True)
    ## ncpr-neighbor.h (module 'ncpr'): ns3::Time ns3::ncpr::Neighbors::GetExpireTime(ns3::Ipv4Address addr) [member function]
    cls.add_method('GetExpireTime', 
                   'ns3::Time', 
                   [param('ns3::Ipv4Address', 'addr')])
    ## ncpr-neighbor.h (module 'ncpr'): ns3::Callback<void, const ns3::WifiMacHeader &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty> ns3::ncpr::Neighbors::GetTxErrorCallback() const [member function]
    cls.add_method('GetTxErrorCallback', 
                   ...
                   [], 
                   is_const=True)
    ## ncpr-neighbor.h (module 'ncpr'): bool ns3::ncpr::Neighbors::IsNeighbor(ns3::Ipv4Address addr) [member function]
    cls.add_method('IsNeighbor', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'addr')])
    ## ncpr-neighbor.h (module 'ncpr'): void ns3::ncpr::Neighbors::Purge() [member function]
    cls.add_method('Purge', 
                   'void', 
                   [])
    ## ncpr-neighbor.h (module 'ncpr'): void ns3::ncpr::Neighbors::ScheduleTimer() [member function]
    cls.add_method('ScheduleTimer', 
                   'void', 
                   [])
    ## ncpr-neighbor.h (module 'ncpr'): void ns3::ncpr::Neighbors::SetCallback(ns3::Callback<void, ns3::Ipv4Address, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty> cb) [member function]
    ...
    ## ncpr-neighbor.h (module 'ncpr'): void ns3::ncpr::Neighbors::Update(ns3::Ipv4Address addr, ns3::Time expire) [member function]
    cls.add_method('Update', 
                   'void', 
                   [param('ns3::Ipv4Address', 'addr'), param('ns3::Time', 'expire')])
    return

def register_Ns3ncprNeighborsNeighbor_methods(root_module, cls):
    ## ncpr-neighbor.h (module 'ncpr'): ns3::ncpr::Neighbors::Neighbor::Neighbor(ns3::ncpr::Neighbors::Neighbor const & arg0) [constructor]
    cls.add_constructor([param('ns3::ncpr::Neighbors::Neighbor const &', 'arg0')])
    ## ncpr-neighbor.h (module 'ncpr'): ns3::ncpr::Neighbors::Neighbor::Neighbor(ns3::Ipv4Address ip, ns3::Mac48Address mac, ns3::Time t) [constructor]
    cls.add_constructor([param('ns3::Ipv4Address', 'ip'), param('ns3::Mac48Address', 'mac'), param('ns3::Time', 't')])
    ## ncpr-neighbor.h (module 'ncpr'): ns3::ncpr::Neighbors::Neighbor::close [variable]
    cls.add_instance_attribute('close', 'bool', is_const=False)
    ## ncpr-neighbor.h (module 'ncpr'): ns3::ncpr::Neighbors::Neighbor::m_expireTime [variable]
    cls.add_instance_attribute('m_expireTime', 'ns3::Time', is_const=False)
    ## ncpr-neighbor.h (module 'ncpr'): ns3::ncpr::Neighbors::Neighbor::m_hardwareAddress [variable]
    cls.add_instance_attribute('m_hardwareAddress', 'ns3::Mac48Address', is_const=False)
    ## ncpr-neighbor.h (module 'ncpr'): ns3::ncpr::Neighbors::Neighbor::m_neighborAddress [variable]
    cls.add_instance_attribute('m_neighborAddress', 'ns3::Ipv4Address', is_const=False)
    return

def register_Ns3ncprQueueEntry_methods(root_module, cls):
    cls.add_binary_comparison_operator('==')
    ## ncpr-rqueue.h (module 'ncpr'): ns3::ncpr::QueueEntry::QueueEntry(ns3::ncpr::QueueEntry const & arg0) [constructor]
    cls.add_constructor([param('ns3::ncpr::QueueEntry const &', 'arg0')])
    ## ncpr-rqueue.h (module 'ncpr'): ns3::ncpr::QueueEntry::QueueEntry(ns3::Ptr<const ns3::Packet> pa=0, ns3::Ipv4Header const & h=ns3::Ipv4Header(), ns3::ncpr::QueueEntry::UnicastForwardCallback ucb=::ns3::Callback<void, ns3::Ptr<ns3::Ipv4Route>, ns3::Ptr<const ns3::Packet>, const ns3::Ipv4Header &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty>( ), ns3::ncpr::QueueEntry::ErrorCallback ecb=::ns3::Callback<void, ns3::Ptr<const ns3::Packet>, const ns3::Ipv4Header &, ns3::Socket::SocketErrno, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty>( ), ns3::Time exp=ns3::Simulator::Now()) [constructor]
    cls.add_constructor([param('ns3::Ptr< ns3::Packet const >', 'pa', default_value='0'), param('ns3::Ipv4Header const &', 'h', default_value='ns3::Ipv4Header()'), param('ns3::ncpr::QueueEntry::UnicastForwardCallback', 'ucb', default_value='::ns3::Callback<void, ns3::Ptr<ns3::Ipv4Route>, ns3::Ptr<const ns3::Packet>, const ns3::Ipv4Header &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty>( )'), param('ns3::ncpr::QueueEntry::ErrorCallback', 'ecb', default_value='::ns3::Callback<void, ns3::Ptr<const ns3::Packet>, const ns3::Ipv4Header &, ns3::Socket::SocketErrno, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty>( )'), param('ns3::Time', 'exp', default_value='ns3::Simulator::Now()')])
    ## ncpr-rqueue.h (module 'ncpr'): ns3::ncpr::QueueEntry::ErrorCallback ns3::ncpr::QueueEntry::GetErrorCallback() const [member function]
    cls.add_method('GetErrorCallback', 
                   'ns3::ncpr::QueueEntry::ErrorCallback', 
                   [], 
                   is_const=True)
    ## ncpr-rqueue.h (module 'ncpr'): ns3::Time ns3::ncpr::QueueEntry::GetExpireTime() const [member function]
    cls.add_method('GetExpireTime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## ncpr-rqueue.h (module 'ncpr'): ns3::Ipv4Header ns3::ncpr::QueueEntry::GetIpv4Header() const [member function]
    cls.add_method('GetIpv4Header', 
                   'ns3::Ipv4Header', 
                   [], 
                   is_const=True)
    ## ncpr-rqueue.h (module 'ncpr'): ns3::Ptr<const ns3::Packet> ns3::ncpr::QueueEntry::GetPacket() const [member function]
    cls.add_method('GetPacket', 
                   'ns3::Ptr< ns3::Packet const >', 
                   [], 
                   is_const=True)
    ## ncpr-rqueue.h (module 'ncpr'): ns3::ncpr::QueueEntry::UnicastForwardCallback ns3::ncpr::QueueEntry::GetUnicastForwardCallback() const [member function]
    cls.add_method('GetUnicastForwardCallback', 
                   'ns3::ncpr::QueueEntry::UnicastForwardCallback', 
                   [], 
                   is_const=True)
    ## ncpr-rqueue.h (module 'ncpr'): void ns3::ncpr::QueueEntry::SetErrorCallback(ns3::ncpr::QueueEntry::ErrorCallback ecb) [member function]
    cls.add_method('SetErrorCallback', 
                   'void', 
                   [param('ns3::Ipv4RoutingProtocol::ErrorCallback', 'ecb')])
    ## ncpr-rqueue.h (module 'ncpr'): void ns3::ncpr::QueueEntry::SetExpireTime(ns3::Time exp) [member function]
    cls.add_method('SetExpireTime', 
                   'void', 
                   [param('ns3::Time', 'exp')])
    ## ncpr-rqueue.h (module 'ncpr'): void ns3::ncpr::QueueEntry::SetIpv4Header(ns3::Ipv4Header h) [member function]
    cls.add_method('SetIpv4Header', 
                   'void', 
                   [param('ns3::Ipv4Header', 'h')])
    ## ncpr-rqueue.h (module 'ncpr'): void ns3::ncpr::QueueEntry::SetPacket(ns3::Ptr<const ns3::Packet> p) [member function]
    cls.add_method('SetPacket', 
                   'void', 
                   [param('ns3::Ptr< ns3::Packet const >', 'p')])
    ## ncpr-rqueue.h (module 'ncpr'): void ns3::ncpr::QueueEntry::SetUnicastForwardCallback(ns3::ncpr::QueueEntry::UnicastForwardCallback ucb) [member function]
    cls.add_method('SetUnicastForwardCallback', 
                   'void', 
                   [param('ns3::Ipv4RoutingProtocol::UnicastForwardCallback', 'ucb')])
    return

def register_Ns3ncprRequestQueue_methods(root_module, cls):
    ## ncpr-rqueue.h (module 'ncpr'): ns3::ncpr::RequestQueue::RequestQueue(ns3::ncpr::RequestQueue const & arg0) [constructor]
    cls.add_constructor([param('ns3::ncpr::RequestQueue const &', 'arg0')])
    ## ncpr-rqueue.h (module 'ncpr'): ns3::ncpr::RequestQueue::RequestQueue(uint32_t maxLen, ns3::Time routeToQueueTimeout) [constructor]
    cls.add_constructor([param('uint32_t', 'maxLen'), param('ns3::Time', 'routeToQueueTimeout')])
    ## ncpr-rqueue.h (module 'ncpr'): bool ns3::ncpr::RequestQueue::Dequeue(ns3::Ipv4Address dst, ns3::ncpr::QueueEntry & entry) [member function]
    cls.add_method('Dequeue', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'dst'), param('ns3::ncpr::QueueEntry &', 'entry')])
    ## ncpr-rqueue.h (module 'ncpr'): void ns3::ncpr::RequestQueue::DropPacketWithDst(ns3::Ipv4Address dst) [member function]
    cls.add_method('DropPacketWithDst', 
                   'void', 
                   [param('ns3::Ipv4Address', 'dst')])
    ## ncpr-rqueue.h (module 'ncpr'): bool ns3::ncpr::RequestQueue::Enqueue(ns3::ncpr::QueueEntry & entry) [member function]
    cls.add_method('Enqueue', 
                   'bool', 
                   [param('ns3::ncpr::QueueEntry &', 'entry')])
    ## ncpr-rqueue.h (module 'ncpr'): bool ns3::ncpr::RequestQueue::Find(ns3::Ipv4Address dst) [member function]
    cls.add_method('Find', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'dst')])
    ## ncpr-rqueue.h (module 'ncpr'): uint32_t ns3::ncpr::RequestQueue::GetMaxQueueLen() const [member function]
    cls.add_method('GetMaxQueueLen', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## ncpr-rqueue.h (module 'ncpr'): ns3::Time ns3::ncpr::RequestQueue::GetQueueTimeout() const [member function]
    cls.add_method('GetQueueTimeout', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## ncpr-rqueue.h (module 'ncpr'): uint32_t ns3::ncpr::RequestQueue::GetSize() [member function]
    cls.add_method('GetSize', 
                   'uint32_t', 
                   [])
    ## ncpr-rqueue.h (module 'ncpr'): void ns3::ncpr::RequestQueue::SetMaxQueueLen(uint32_t len) [member function]
    cls.add_method('SetMaxQueueLen', 
                   'void', 
                   [param('uint32_t', 'len')])
    ## ncpr-rqueue.h (module 'ncpr'): void ns3::ncpr::RequestQueue::SetQueueTimeout(ns3::Time t) [member function]
    cls.add_method('SetQueueTimeout', 
                   'void', 
                   [param('ns3::Time', 't')])
    return

def register_Ns3ncprRerrHeader_methods(root_module, cls):
    cls.add_output_stream_operator()
    cls.add_binary_comparison_operator('==')
    ## ncpr-packet.h (module 'ncpr'): ns3::ncpr::RerrHeader::RerrHeader(ns3::ncpr::RerrHeader const & arg0) [constructor]
    cls.add_constructor([param('ns3::ncpr::RerrHeader const &', 'arg0')])
    ## ncpr-packet.h (module 'ncpr'): ns3::ncpr::RerrHeader::RerrHeader() [constructor]
    cls.add_constructor([])
    ## ncpr-packet.h (module 'ncpr'): bool ns3::ncpr::RerrHeader::AddUnDestination(ns3::Ipv4Address dst, uint32_t seqNo) [member function]
    cls.add_method('AddUnDestination', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'dst'), param('uint32_t', 'seqNo')])
    ## ncpr-packet.h (module 'ncpr'): void ns3::ncpr::RerrHeader::Clear() [member function]
    cls.add_method('Clear', 
                   'void', 
                   [])
    ## ncpr-packet.h (module 'ncpr'): uint32_t ns3::ncpr::RerrHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## ncpr-packet.h (module 'ncpr'): uint8_t ns3::ncpr::RerrHeader::GetDestCount() const [member function]
    cls.add_method('GetDestCount', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## ncpr-packet.h (module 'ncpr'): ns3::TypeId ns3::ncpr::RerrHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## ncpr-packet.h (module 'ncpr'): bool ns3::ncpr::RerrHeader::GetNoDelete() const [member function]
    cls.add_method('GetNoDelete', 
                   'bool', 
                   [], 
                   is_const=True)
    ## ncpr-packet.h (module 'ncpr'): uint32_t ns3::ncpr::RerrHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## ncpr-packet.h (module 'ncpr'): static ns3::TypeId ns3::ncpr::RerrHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## ncpr-packet.h (module 'ncpr'): void ns3::ncpr::RerrHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## ncpr-packet.h (module 'ncpr'): bool ns3::ncpr::RerrHeader::RemoveUnDestination(std::pair<ns3::Ipv4Address, unsigned int> & un) [member function]
    cls.add_method('RemoveUnDestination', 
                   'bool', 
                   [param('std::pair< ns3::Ipv4Address, unsigned int > &', 'un')])
    ## ncpr-packet.h (module 'ncpr'): void ns3::ncpr::RerrHeader::Serialize(ns3::Buffer::Iterator i) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'i')], 
                   is_const=True, is_virtual=True)
    ## ncpr-packet.h (module 'ncpr'): void ns3::ncpr::RerrHeader::SetNoDelete(bool f) [member function]
    cls.add_method('SetNoDelete', 
                   'void', 
                   [param('bool', 'f')])
    return

def register_Ns3ncprRoutingProtocol_methods(root_module, cls):
    ## ncpr-routing-protocol.h (module 'ncpr'): ns3::ncpr::RoutingProtocol::RoutingProtocol(ns3::ncpr::RoutingProtocol const & arg0) [constructor]
    cls.add_constructor([param('ns3::ncpr::RoutingProtocol const &', 'arg0')])
    ## ncpr-routing-protocol.h (module 'ncpr'): ns3::ncpr::RoutingProtocol::RoutingProtocol() [constructor]
    cls.add_constructor([])
    ## ncpr-routing-protocol.h (module 'ncpr'): int64_t ns3::ncpr::RoutingProtocol::AssignStreams(int64_t stream) [member function]
    cls.add_method('AssignStreams', 
                   'int64_t', 
                   [param('int64_t', 'stream')])
    ## ncpr-routing-protocol.h (module 'ncpr'): void ns3::ncpr::RoutingProtocol::DoDispose() [member function]
    cls.add_method('DoDispose', 
                   'void', 
                   [], 
                   is_virtual=True)
    ## ncpr-routing-protocol.h (module 'ncpr'): bool ns3::ncpr::RoutingProtocol::GetBroadcastEnable() const [member function]
    cls.add_method('GetBroadcastEnable', 
                   'bool', 
                   [], 
                   is_const=True)
    ## ncpr-routing-protocol.h (module 'ncpr'): bool ns3::ncpr::RoutingProtocol::GetDestinationOnlyFlag() const [member function]
    cls.add_method('GetDestinationOnlyFlag', 
                   'bool', 
                   [], 
                   is_const=True)
    ## ncpr-routing-protocol.h (module 'ncpr'): bool ns3::ncpr::RoutingProtocol::GetGratuitousReplyFlag() const [member function]
    cls.add_method('GetGratuitousReplyFlag', 
                   'bool', 
                   [], 
                   is_const=True)
    ## ncpr-routing-protocol.h (module 'ncpr'): bool ns3::ncpr::RoutingProtocol::GetHelloEnable() const [member function]
    cls.add_method('GetHelloEnable', 
                   'bool', 
                   [], 
                   is_const=True)
    ## ncpr-routing-protocol.h (module 'ncpr'): uint32_t ns3::ncpr::RoutingProtocol::GetMaxQueueLen() const [member function]
    cls.add_method('GetMaxQueueLen', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## ncpr-routing-protocol.h (module 'ncpr'): ns3::Time ns3::ncpr::RoutingProtocol::GetMaxQueueTime() const [member function]
    cls.add_method('GetMaxQueueTime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## ncpr-routing-protocol.h (module 'ncpr'): static ns3::TypeId ns3::ncpr::RoutingProtocol::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## ncpr-routing-protocol.h (module 'ncpr'): void ns3::ncpr::RoutingProtocol::NotifyAddAddress(uint32_t interface, ns3::Ipv4InterfaceAddress address) [member function]
    cls.add_method('NotifyAddAddress', 
                   'void', 
                   [param('uint32_t', 'interface'), param('ns3::Ipv4InterfaceAddress', 'address')], 
                   is_virtual=True)
    ## ncpr-routing-protocol.h (module 'ncpr'): void ns3::ncpr::RoutingProtocol::NotifyInterfaceDown(uint32_t interface) [member function]
    cls.add_method('NotifyInterfaceDown', 
                   'void', 
                   [param('uint32_t', 'interface')], 
                   is_virtual=True)
    ## ncpr-routing-protocol.h (module 'ncpr'): void ns3::ncpr::RoutingProtocol::NotifyInterfaceUp(uint32_t interface) [member function]
    cls.add_method('NotifyInterfaceUp', 
                   'void', 
                   [param('uint32_t', 'interface')], 
                   is_virtual=True)
    ## ncpr-routing-protocol.h (module 'ncpr'): void ns3::ncpr::RoutingProtocol::NotifyRemoveAddress(uint32_t interface, ns3::Ipv4InterfaceAddress address) [member function]
    cls.add_method('NotifyRemoveAddress', 
                   'void', 
                   [param('uint32_t', 'interface'), param('ns3::Ipv4InterfaceAddress', 'address')], 
                   is_virtual=True)
    ## ncpr-routing-protocol.h (module 'ncpr'): void ns3::ncpr::RoutingProtocol::PrintRoutingTable(ns3::Ptr<ns3::OutputStreamWrapper> stream, ns3::Time::Unit unit=::ns3::Time::Unit::S) const [member function]
    cls.add_method('PrintRoutingTable', 
                   'void', 
                   [param('ns3::Ptr< ns3::OutputStreamWrapper >', 'stream'), param('ns3::Time::Unit', 'unit', default_value='::ns3::Time::Unit::S')], 
                   is_const=True, is_virtual=True)
    ## ncpr-routing-protocol.h (module 'ncpr'): bool ns3::ncpr::RoutingProtocol::RouteInput(ns3::Ptr<const ns3::Packet> p, ns3::Ipv4Header const & header, ns3::Ptr<const ns3::NetDevice> idev, ns3::Ipv4RoutingProtocol::UnicastForwardCallback ucb, ns3::Ipv4RoutingProtocol::MulticastForwardCallback mcb, ns3::Ipv4RoutingProtocol::LocalDeliverCallback lcb, ns3::Ipv4RoutingProtocol::ErrorCallback ecb) [member function]
    cls.add_method('RouteInput', 
                   'bool', 
                   [param('ns3::Ptr< ns3::Packet const >', 'p'), param('ns3::Ipv4Header const &', 'header'), param('ns3::Ptr< ns3::NetDevice const >', 'idev'), param('ns3::Callback< void, ns3::Ptr< ns3::Ipv4Route >, ns3::Ptr< ns3::Packet const >, ns3::Ipv4Header const &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'ucb'), param('ns3::Callback< void, ns3::Ptr< ns3::Ipv4MulticastRoute >, ns3::Ptr< ns3::Packet const >, ns3::Ipv4Header const &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'mcb'), param('ns3::Callback< void, ns3::Ptr< ns3::Packet const >, ns3::Ipv4Header const &, unsigned int, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'lcb'), param('ns3::Callback< void, ns3::Ptr< ns3::Packet const >, ns3::Ipv4Header const &, ns3::Socket::SocketErrno, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'ecb')], 
                   is_virtual=True)
    ## ncpr-routing-protocol.h (module 'ncpr'): ns3::Ptr<ns3::Ipv4Route> ns3::ncpr::RoutingProtocol::RouteOutput(ns3::Ptr<ns3::Packet> p, ns3::Ipv4Header const & header, ns3::Ptr<ns3::NetDevice> oif, ns3::Socket::SocketErrno & sockerr) [member function]
    cls.add_method('RouteOutput', 
                   'ns3::Ptr< ns3::Ipv4Route >', 
                   [param('ns3::Ptr< ns3::Packet >', 'p'), param('ns3::Ipv4Header const &', 'header'), param('ns3::Ptr< ns3::NetDevice >', 'oif'), param('ns3::Socket::SocketErrno &', 'sockerr')], 
                   is_virtual=True)
    ## ncpr-routing-protocol.h (module 'ncpr'): void ns3::ncpr::RoutingProtocol::SetBroadcastEnable(bool f) [member function]
    cls.add_method('SetBroadcastEnable', 
                   'void', 
                   [param('bool', 'f')])
    ## ncpr-routing-protocol.h (module 'ncpr'): void ns3::ncpr::RoutingProtocol::SetDestinationOnlyFlag(bool f) [member function]
    cls.add_method('SetDestinationOnlyFlag', 
                   'void', 
                   [param('bool', 'f')])
    ## ncpr-routing-protocol.h (module 'ncpr'): void ns3::ncpr::RoutingProtocol::SetGratuitousReplyFlag(bool f) [member function]
    cls.add_method('SetGratuitousReplyFlag', 
                   'void', 
                   [param('bool', 'f')])
    ## ncpr-routing-protocol.h (module 'ncpr'): void ns3::ncpr::RoutingProtocol::SetHelloEnable(bool f) [member function]
    cls.add_method('SetHelloEnable', 
                   'void', 
                   [param('bool', 'f')])
    ## ncpr-routing-protocol.h (module 'ncpr'): void ns3::ncpr::RoutingProtocol::SetIpv4(ns3::Ptr<ns3::Ipv4> ipv4) [member function]
    cls.add_method('SetIpv4', 
                   'void', 
                   [param('ns3::Ptr< ns3::Ipv4 >', 'ipv4')], 
                   is_virtual=True)
    ## ncpr-routing-protocol.h (module 'ncpr'): void ns3::ncpr::RoutingProtocol::SetMaxQueueLen(uint32_t len) [member function]
    cls.add_method('SetMaxQueueLen', 
                   'void', 
                   [param('uint32_t', 'len')])
    ## ncpr-routing-protocol.h (module 'ncpr'): void ns3::ncpr::RoutingProtocol::SetMaxQueueTime(ns3::Time t) [member function]
    cls.add_method('SetMaxQueueTime', 
                   'void', 
                   [param('ns3::Time', 't')])
    ## ncpr-routing-protocol.h (module 'ncpr'): ns3::ncpr::RoutingProtocol::ncpr_PORT [variable]
    cls.add_static_attribute('ncpr_PORT', 'uint32_t const', is_const=True)
    ## ncpr-routing-protocol.h (module 'ncpr'): void ns3::ncpr::RoutingProtocol::DoInitialize() [member function]
    cls.add_method('DoInitialize', 
                   'void', 
                   [], 
                   visibility='protected', is_virtual=True)
...
def register_Ns3ncprRoutingTable_methods(root_module, cls):
    ## ncpr-rtable.h (module 'ncpr'): ns3::ncpr::RoutingTable::RoutingTable(ns3::ncpr::RoutingTable const & arg0) [constructor]
    cls.add_constructor([param('ns3::ncpr::RoutingTable const &', 'arg0')])
    ## ncpr-rtable.h (module 'ncpr'): ns3::ncpr::RoutingTable::RoutingTable(ns3::Time t) [constructor]
    cls.add_constructor([param('ns3::Time', 't')])
    ## ncpr-rtable.h (module 'ncpr'): bool ns3::ncpr::RoutingTable::AddRoute(ns3::ncpr::RoutingTableEntry & r) [member function]
    cls.add_method('AddRoute', 
                   'bool', 
                   [param('ns3::ncpr::RoutingTableEntry &', 'r')])
    ## ncpr-rtable.h (module 'ncpr'): void ns3::ncpr::RoutingTable::Clear() [member function]
    cls.add_method('Clear', 
                   'void', 
                   [])
    ## ncpr-rtable.h (module 'ncpr'): void ns3::ncpr::RoutingTable::DeleteAllRoutesFromInterface(ns3::Ipv4InterfaceAddress iface) [member function]
    cls.add_method('DeleteAllRoutesFromInterface', 
                   'void', 
                   [param('ns3::Ipv4InterfaceAddress', 'iface')])
    ## ncpr-rtable.h (module 'ncpr'): bool ns3::ncpr::RoutingTable::DeleteRoute(ns3::Ipv4Address dst) [member function]
    cls.add_method('DeleteRoute', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'dst')])
    ## ncpr-rtable.h (module 'ncpr'): ns3::Time ns3::ncpr::RoutingTable::GetBadLinkLifetime() const [member function]
    cls.add_method('GetBadLinkLifetime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## ncpr-rtable.h (module 'ncpr'): void ns3::ncpr::RoutingTable::GetListOfDestinationWithNextHop(ns3::Ipv4Address nextHop, std::map<ns3::Ipv4Address, unsigned int, std::less<ns3::Ipv4Address>, std::allocator<std::pair<const ns3::Ipv4Address, unsigned int> > > & unreachable) [member function]
    ...
    ## ncpr-rtable.h (module 'ncpr'): void ns3::ncpr::RoutingTable::InvalidateRoutesWithDst(std::map<ns3::Ipv4Address, unsigned int, std::less<ns3::Ipv4Address>, std::allocator<std::pair<const ns3::Ipv4Address, unsigned int> > > const & unreachable) [member function]
    cls.add_method('InvalidateRoutesWithDst', 
                   'void', 
                   [param('std::map< ns3::Ipv4Address, unsigned int > const &', 'unreachable')])
    ## ncpr-rtable.h (module 'ncpr'): bool ns3::ncpr::RoutingTable::LookupRoute(ns3::Ipv4Address dst, ns3::ncpr::RoutingTableEntry & rt) [member function]
    cls.add_method('LookupRoute', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'dst'), param('ns3::ncpr::RoutingTableEntry &', 'rt')])
    ## ncpr-rtable.h (module 'ncpr'): bool ns3::ncpr::RoutingTable::LookupValidRoute(ns3::Ipv4Address dst, ns3::ncpr::RoutingTableEntry & rt) [member function]
    cls.add_method('LookupValidRoute', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'dst'), param('ns3::ncpr::RoutingTableEntry &', 'rt')])
    ## ncpr-rtable.h (module 'ncpr'): bool ns3::ncpr::RoutingTable::MarkLinkAsUnidirectional(ns3::Ipv4Address neighbor, ns3::Time blacklistTimeout) [member function]
    cls.add_method('MarkLinkAsUnidirectional', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'neighbor'), param('ns3::Time', 'blacklistTimeout')])
    ## ncpr-rtable.h (module 'ncpr'): void ns3::ncpr::RoutingTable::Print(ns3::Ptr<ns3::OutputStreamWrapper> stream) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('ns3::Ptr< ns3::OutputStreamWrapper >', 'stream')], 
                   is_const=True)
    ## ncpr-rtable.h (module 'ncpr'): void ns3::ncpr::RoutingTable::Purge() [member function]
    cls.add_method('Purge', 
                   'void', 
                   [])
    ## ncpr-rtable.h (module 'ncpr'): void ns3::ncpr::RoutingTable::SetBadLinkLifetime(ns3::Time t) [member function]
    cls.add_method('SetBadLinkLifetime', 
                   'void', 
                   [param('ns3::Time', 't')])
    ## ncpr-rtable.h (module 'ncpr'): bool ns3::ncpr::RoutingTable::SetEntryState(ns3::Ipv4Address dst, ns3::ncpr::RouteFlags state) [member function]
    cls.add_method('SetEntryState', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'dst'), param('ns3::ncpr::RouteFlags', 'state')])
    ## ncpr-rtable.h (module 'ncpr'): bool ns3::ncpr::RoutingTable::Update(ns3::ncpr::RoutingTableEntry & rt) [member function]
    cls.add_method('Update', 
                   'bool', 
                   [param('ns3::ncpr::RoutingTableEntry &', 'rt')])
    return

def register_Ns3ncprRoutingTableEntry_methods(root_module, cls):
    ## ncpr-rtable.h (module 'ncpr'): ns3::ncpr::RoutingTableEntry::RoutingTableEntry(ns3::ncpr::RoutingTableEntry const & arg0) [constructor]
    cls.add_constructor([param('ns3::ncpr::RoutingTableEntry const &', 'arg0')])
    ## ncpr-rtable.h (module 'ncpr'): ns3::ncpr::RoutingTableEntry::RoutingTableEntry(ns3::Ptr<ns3::NetDevice> dev=0, ns3::Ipv4Address dst=ns3::Ipv4Address(), bool vSeqNo=false, uint32_t seqNo=0, ns3::Ipv4InterfaceAddress iface=ns3::Ipv4InterfaceAddress(), uint16_t hops=0, ns3::Ipv4Address nextHop=ns3::Ipv4Address(), ns3::Time lifetime=ns3::Simulator::Now()) [constructor]
    ...
    ## ncpr-rtable.h (module 'ncpr'): void ns3::ncpr::RoutingTableEntry::DeleteAllPrecursors() [member function]
    cls.add_method('DeleteAllPrecursors', 
                   'void', 
                   [])
    ## ncpr-rtable.h (module 'ncpr'): bool ns3::ncpr::RoutingTableEntry::DeletePrecursor(ns3::Ipv4Address id) [member function]
    cls.add_method('DeletePrecursor', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'id')])
    ## ncpr-rtable.h (module 'ncpr'): ns3::Time ns3::ncpr::RoutingTableEntry::GetBlacklistTimeout() const [member function]
    cls.add_method('GetBlacklistTimeout', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## ncpr-rtable.h (module 'ncpr'): ns3::Ipv4Address ns3::ncpr::RoutingTableEntry::GetDestination() const [member function]
    cls.add_method('GetDestination', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## ncpr-rtable.h (module 'ncpr'): ns3::ncpr::RouteFlags ns3::ncpr::RoutingTableEntry::GetFlag() const [member function]
    cls.add_method('GetFlag', 
                   'ns3::ncpr::RouteFlags', 
                   [], 
                   is_const=True)
    ## ncpr-rtable.h (module 'ncpr'): uint16_t ns3::ncpr::RoutingTableEntry::GetHop() const [member function]
    cls.add_method('GetHop', 
                   'uint16_t', 
                   [], 
                   is_const=True)
    ## ncpr-rtable.h (module 'ncpr'): ns3::Ipv4InterfaceAddress ns3::ncpr::RoutingTableEntry::GetInterface() const [member function]
    cls.add_method('GetInterface', 
                   'ns3::Ipv4InterfaceAddress', 
                   [], 
                   is_const=True)
    ## ncpr-rtable.h (module 'ncpr'): ns3::Time ns3::ncpr::RoutingTableEntry::GetLifeTime() const [member function]
    cls.add_method('GetLifeTime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## ncpr-rtable.h (module 'ncpr'): ns3::Ipv4Address ns3::ncpr::RoutingTableEntry::GetNextHop() const [member function]
    cls.add_method('GetNextHop', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## ncpr-rtable.h (module 'ncpr'): ns3::Ptr<ns3::NetDevice> ns3::ncpr::RoutingTableEntry::GetOutputDevice() const [member function]
    cls.add_method('GetOutputDevice', 
                   'ns3::Ptr< ns3::NetDevice >', 
                   [], 
                   is_const=True)
    ## ncpr-rtable.h (module 'ncpr'): void ns3::ncpr::RoutingTableEntry::GetPrecursors(std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > & prec) const [member function]
    cls.add_method('GetPrecursors', 
                   'void', 
                   [param('std::vector< ns3::Ipv4Address > &', 'prec')], 
                   is_const=True)
    ## ncpr-rtable.h (module 'ncpr'): ns3::Ptr<ns3::Ipv4Route> ns3::ncpr::RoutingTableEntry::GetRoute() const [member function]
    cls.add_method('GetRoute', 
                   'ns3::Ptr< ns3::Ipv4Route >', 
                   [], 
                   is_const=True)
    ## ncpr-rtable.h (module 'ncpr'): uint8_t ns3::ncpr::RoutingTableEntry::GetRreqCnt() const [member function]
    cls.add_method('GetRreqCnt', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## ncpr-rtable.h (module 'ncpr'): uint32_t ns3::ncpr::RoutingTableEntry::GetSeqNo() const [member function]
    cls.add_method('GetSeqNo', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## ncpr-rtable.h (module 'ncpr'): bool ns3::ncpr::RoutingTableEntry::GetValidSeqNo() const [member function]
    cls.add_method('GetValidSeqNo', 
                   'bool', 
                   [], 
                   is_const=True)
    ## ncpr-rtable.h (module 'ncpr'): void ns3::ncpr::RoutingTableEntry::IncrementRreqCnt() [member function]
    cls.add_method('IncrementRreqCnt', 
                   'void', 
                   [])
    ## ncpr-rtable.h (module 'ncpr'): bool ns3::ncpr::RoutingTableEntry::InsertPrecursor(ns3::Ipv4Address id) [member function]
    cls.add_method('InsertPrecursor', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'id')])
    ## ncpr-rtable.h (module 'ncpr'): void ns3::ncpr::RoutingTableEntry::Invalidate(ns3::Time badLinkLifetime) [member function]
    cls.add_method('Invalidate', 
                   'void', 
                   [param('ns3::Time', 'badLinkLifetime')])
    ## ncpr-rtable.h (module 'ncpr'): bool ns3::ncpr::RoutingTableEntry::IsPrecursorListEmpty() const [member function]
    cls.add_method('IsPrecursorListEmpty', 
                   'bool', 
                   [], 
                   is_const=True)
    ## ncpr-rtable.h (module 'ncpr'): bool ns3::ncpr::RoutingTableEntry::IsUnidirectional() const [member function]
    cls.add_method('IsUnidirectional', 
                   'bool', 
                   [], 
                   is_const=True)
    ## ncpr-rtable.h (module 'ncpr'): bool ns3::ncpr::RoutingTableEntry::LookupPrecursor(ns3::Ipv4Address id) [member function]
    cls.add_method('LookupPrecursor', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'id')])
    ## ncpr-rtable.h (module 'ncpr'): void ns3::ncpr::RoutingTableEntry::Print(ns3::Ptr<ns3::OutputStreamWrapper> stream) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('ns3::Ptr< ns3::OutputStreamWrapper >', 'stream')], 
                   is_const=True)
    ## ncpr-rtable.h (module 'ncpr'): void ns3::ncpr::RoutingTableEntry::SetBlacklistTimeout(ns3::Time t) [member function]
    cls.add_method('SetBlacklistTimeout', 
                   'void', 
                   [param('ns3::Time', 't')])
    ## ncpr-rtable.h (module 'ncpr'): void ns3::ncpr::RoutingTableEntry::SetFlag(ns3::ncpr::RouteFlags flag) [member function]
    cls.add_method('SetFlag', 
                   'void', 
                   [param('ns3::ncpr::RouteFlags', 'flag')])
    ## ncpr-rtable.h (module 'ncpr'): void ns3::ncpr::RoutingTableEntry::SetHop(uint16_t hop) [member function]
    cls.add_method('SetHop', 
                   'void', 
                   [param('uint16_t', 'hop')])
    ## ncpr-rtable.h (module 'ncpr'): void ns3::ncpr::RoutingTableEntry::SetInterface(ns3::Ipv4InterfaceAddress iface) [member function]
    cls.add_method('SetInterface', 
                   'void', 
                   [param('ns3::Ipv4InterfaceAddress', 'iface')])
    ## ncpr-rtable.h (module 'ncpr'): void ns3::ncpr::RoutingTableEntry::SetLifeTime(ns3::Time lt) [member function]
    cls.add_method('SetLifeTime', 
                   'void', 
                   [param('ns3::Time', 'lt')])
    ## ncpr-rtable.h (module 'ncpr'): void ns3::ncpr::RoutingTableEntry::SetNextHop(ns3::Ipv4Address nextHop) [member function]
    cls.add_method('SetNextHop', 
                   'void', 
                   [param('ns3::Ipv4Address', 'nextHop')])
    ## ncpr-rtable.h (module 'ncpr'): void ns3::ncpr::RoutingTableEntry::SetOutputDevice(ns3::Ptr<ns3::NetDevice> dev) [member function]
    cls.add_method('SetOutputDevice', 
                   'void', 
                   [param('ns3::Ptr< ns3::NetDevice >', 'dev')])
    ## ncpr-rtable.h (module 'ncpr'): void ns3::ncpr::RoutingTableEntry::SetRoute(ns3::Ptr<ns3::Ipv4Route> r) [member function]
    cls.add_method('SetRoute', 
                   'void', 
                   [param('ns3::Ptr< ns3::Ipv4Route >', 'r')])
    ## ncpr-rtable.h (module 'ncpr'): void ns3::ncpr::RoutingTableEntry::SetRreqCnt(uint8_t n) [member function]
    cls.add_method('SetRreqCnt', 
                   'void', 
                   [param('uint8_t', 'n')])
    ## ncpr-rtable.h (module 'ncpr'): void ns3::ncpr::RoutingTableEntry::SetSeqNo(uint32_t sn) [member function]
    cls.add_method('SetSeqNo', 
                   'void', 
                   [param('uint32_t', 'sn')])
    ## ncpr-rtable.h (module 'ncpr'): void ns3::ncpr::RoutingTableEntry::SetUnidirectional(bool u) [member function]
    cls.add_method('SetUnidirectional', 
                   'void', 
                   [param('bool', 'u')])
    ## ncpr-rtable.h (module 'ncpr'): void ns3::ncpr::RoutingTableEntry::SetValidSeqNo(bool s) [member function]
    cls.add_method('SetValidSeqNo', 
                   'void', 
                   [param('bool', 's')])
    ## ncpr-rtable.h (module 'ncpr'): ns3::ncpr::RoutingTableEntry::m_ackTimer [variable]
    cls.add_instance_attribute('m_ackTimer', 'ns3::Timer', is_const=False)
    return

def register_Ns3ncprRrepAckHeader_methods(root_module, cls):
    cls.add_output_stream_operator()
    cls.add_binary_comparison_operator('==')
    ## ncpr-packet.h (module 'ncpr'): ns3::ncpr::RrepAckHeader::RrepAckHeader(ns3::ncpr::RrepAckHeader const & arg0) [constructor]
    cls.add_constructor([param('ns3::ncpr::RrepAckHeader const &', 'arg0')])
    ## ncpr-packet.h (module 'ncpr'): ns3::ncpr::RrepAckHeader::RrepAckHeader() [constructor]
    cls.add_constructor([])
    ## ncpr-packet.h (module 'ncpr'): uint32_t ns3::ncpr::RrepAckHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## ncpr-packet.h (module 'ncpr'): ns3::TypeId ns3::ncpr::RrepAckHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## ncpr-packet.h (module 'ncpr'): uint32_t ns3::ncpr::RrepAckHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## ncpr-packet.h (module 'ncpr'): static ns3::TypeId ns3::ncpr::RrepAckHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## ncpr-packet.h (module 'ncpr'): void ns3::ncpr::RrepAckHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## ncpr-packet.h (module 'ncpr'): void ns3::ncpr::RrepAckHeader::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
...
def register_Ns3ncprRrepHeader_methods(root_module, cls):
    cls.add_output_stream_operator()
    cls.add_binary_comparison_operator('==')
    ## ncpr-packet.h (module 'ncpr'): ns3::ncpr::RrepHeader::RrepHeader(ns3::ncpr::RrepHeader const & arg0) [constructor]
    cls.add_constructor([param('ns3::ncpr::RrepHeader const &', 'arg0')])
    ## ncpr-packet.h (module 'ncpr'): ns3::ncpr::RrepHeader::RrepHeader(uint8_t prefixSize=0, uint8_t hopCount=0, ns3::Ipv4Address dst=ns3::Ipv4Address(), uint32_t dstSeqNo=0, ns3::Ipv4Address origin=ns3::Ipv4Address(), ns3::Time lifetime=ns3::MilliSeconds(0)) [constructor]
    ...
    ## ncpr-packet.h (module 'ncpr'): uint32_t ns3::ncpr::RrepHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## ncpr-packet.h (module 'ncpr'): bool ns3::ncpr::RrepHeader::GetAckRequired() const [member function]
    cls.add_method('GetAckRequired', 
                   'bool', 
                   [], 
                   is_const=True)
    ## ncpr-packet.h (module 'ncpr'): ns3::Ipv4Address ns3::ncpr::RrepHeader::GetDst() const [member function]
    cls.add_method('GetDst', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## ncpr-packet.h (module 'ncpr'): uint32_t ns3::ncpr::RrepHeader::GetDstSeqno() const [member function]
    cls.add_method('GetDstSeqno', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## ncpr-packet.h (module 'ncpr'): uint8_t ns3::ncpr::RrepHeader::GetHopCount() const [member function]
    cls.add_method('GetHopCount', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## ncpr-packet.h (module 'ncpr'): ns3::TypeId ns3::ncpr::RrepHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## ncpr-packet.h (module 'ncpr'): ns3::Time ns3::ncpr::RrepHeader::GetLifeTime() const [member function]
    cls.add_method('GetLifeTime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## ncpr-packet.h (module 'ncpr'): ns3::Ipv4Address ns3::ncpr::RrepHeader::GetOrigin() const [member function]
    cls.add_method('GetOrigin', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## ncpr-packet.h (module 'ncpr'): uint8_t ns3::ncpr::RrepHeader::GetPrefixSize() const [member function]
    cls.add_method('GetPrefixSize', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## ncpr-packet.h (module 'ncpr'): uint32_t ns3::ncpr::RrepHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## ncpr-packet.h (module 'ncpr'): static ns3::TypeId ns3::ncpr::RrepHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## ncpr-packet.h (module 'ncpr'): void ns3::ncpr::RrepHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## ncpr-packet.h (module 'ncpr'): void ns3::ncpr::RrepHeader::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
    ## ncpr-packet.h (module 'ncpr'): void ns3::ncpr::RrepHeader::SetAckRequired(bool f) [member function]
    cls.add_method('SetAckRequired', 
                   'void', 
                   [param('bool', 'f')])
    ## ncpr-packet.h (module 'ncpr'): void ns3::ncpr::RrepHeader::SetDst(ns3::Ipv4Address a) [member function]
    cls.add_method('SetDst', 
                   'void', 
                   [param('ns3::Ipv4Address', 'a')])
    ## ncpr-packet.h (module 'ncpr'): void ns3::ncpr::RrepHeader::SetDstSeqno(uint32_t s) [member function]
    cls.add_method('SetDstSeqno', 
                   'void', 
                   [param('uint32_t', 's')])
    ## ncpr-packet.h (module 'ncpr'): void ns3::ncpr::RrepHeader::SetHello(ns3::Ipv4Address src, uint32_t srcSeqNo, ns3::Time lifetime) [member function]
    cls.add_method('SetHello', 
                   'void', 
                   [param('ns3::Ipv4Address', 'src'), param('uint32_t', 'srcSeqNo'), param('ns3::Time', 'lifetime')])
    ## ncpr-packet.h (module 'ncpr'): void ns3::ncpr::RrepHeader::SetHopCount(uint8_t count) [member function]
    cls.add_method('SetHopCount', 
                   'void', 
                   [param('uint8_t', 'count')])
    ## ncpr-packet.h (module 'ncpr'): void ns3::ncpr::RrepHeader::SetLifeTime(ns3::Time t) [member function]
    cls.add_method('SetLifeTime', 
                   'void', 
                   [param('ns3::Time', 't')])
    ## ncpr-packet.h (module 'ncpr'): void ns3::ncpr::RrepHeader::SetOrigin(ns3::Ipv4Address a) [member function]
    cls.add_method('SetOrigin', 
                   'void', 
                   [param('ns3::Ipv4Address', 'a')])
    ## ncpr-packet.h (module 'ncpr'): void ns3::ncpr::RrepHeader::SetPrefixSize(uint8_t sz) [member function]
    cls.add_method('SetPrefixSize', 
                   'void', 
                   [param('uint8_t', 'sz')])
    return

def register_Ns3ncprRreqHeader_methods(root_module, cls):
    cls.add_output_stream_operator()
    cls.add_binary_comparison_operator('==')
    ## ncpr-packet.h (module 'ncpr'): ns3::ncpr::RreqHeader::RreqHeader(ns3::ncpr::RreqHeader const & arg0) [constructor]
    cls.add_constructor([param('ns3::ncpr::RreqHeader const &', 'arg0')])
    ## ncpr-packet.h (module 'ncpr'): ns3::ncpr::RreqHeader::RreqHeader(uint8_t flags=0, uint8_t reserved=0, uint8_t hopCount=0, uint32_t requestID=0, ns3::Ipv4Address dst=ns3::Ipv4Address(), uint32_t dstSeqNo=0, ns3::Ipv4Address origin=ns3::Ipv4Address(), uint32_t originSeqNo=0) [constructor]
    ...
    ## ncpr-packet.h (module 'ncpr'): uint32_t ns3::ncpr::RreqHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## ncpr-packet.h (module 'ncpr'): bool ns3::ncpr::RreqHeader::GetDestinationOnly() const [member function]
    cls.add_method('GetDestinationOnly', 
                   'bool', 
                   [], 
                   is_const=True)
    ## ncpr-packet.h (module 'ncpr'): ns3::Ipv4Address ns3::ncpr::RreqHeader::GetDst() const [member function]
    cls.add_method('GetDst', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## ncpr-packet.h (module 'ncpr'): uint32_t ns3::ncpr::RreqHeader::GetDstSeqno() const [member function]
    cls.add_method('GetDstSeqno', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## ncpr-packet.h (module 'ncpr'): bool ns3::ncpr::RreqHeader::GetGratuitousRrep() const [member function]
    cls.add_method('GetGratuitousRrep', 
                   'bool', 
                   [], 
                   is_const=True)
    ## ncpr-packet.h (module 'ncpr'): uint8_t ns3::ncpr::RreqHeader::GetHopCount() const [member function]
    cls.add_method('GetHopCount', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## ncpr-packet.h (module 'ncpr'): uint32_t ns3::ncpr::RreqHeader::GetId() const [member function]
    cls.add_method('GetId', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## ncpr-packet.h (module 'ncpr'): ns3::TypeId ns3::ncpr::RreqHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## ncpr-packet.h (module 'ncpr'): ns3::Ipv4Address ns3::ncpr::RreqHeader::GetOrigin() const [member function]
    cls.add_method('GetOrigin', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## ncpr-packet.h (module 'ncpr'): uint32_t ns3::ncpr::RreqHeader::GetOriginSeqno() const [member function]
    cls.add_method('GetOriginSeqno', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## ncpr-packet.h (module 'ncpr'): uint32_t ns3::ncpr::RreqHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## ncpr-packet.h (module 'ncpr'): static ns3::TypeId ns3::ncpr::RreqHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## ncpr-packet.h (module 'ncpr'): bool ns3::ncpr::RreqHeader::GetUnknownSeqno() const [member function]
    cls.add_method('GetUnknownSeqno', 
                   'bool', 
                   [], 
                   is_const=True)
    ## ncpr-packet.h (module 'ncpr'): void ns3::ncpr::RreqHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## ncpr-packet.h (module 'ncpr'): void ns3::ncpr::RreqHeader::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
    ## ncpr-packet.h (module 'ncpr'): void ns3::ncpr::RreqHeader::SetDestinationOnly(bool f) [member function]
    cls.add_method('SetDestinationOnly', 
                   'void', 
                   [param('bool', 'f')])
    ## ncpr-packet.h (module 'ncpr'): void ns3::ncpr::RreqHeader::SetDst(ns3::Ipv4Address a) [member function]
    cls.add_method('SetDst', 
                   'void', 
                   [param('ns3::Ipv4Address', 'a')])
    ## ncpr-packet.h (module 'ncpr'): void ns3::ncpr::RreqHeader::SetDstSeqno(uint32_t s) [member function]
    cls.add_method('SetDstSeqno', 
                   'void', 
                   [param('uint32_t', 's')])
    ## ncpr-packet.h (module 'ncpr'): void ns3::ncpr::RreqHeader::SetGratuitousRrep(bool f) [member function]
    cls.add_method('SetGratuitousRrep', 
                   'void', 
                   [param('bool', 'f')])
    ## ncpr-packet.h (module 'ncpr'): void ns3::ncpr::RreqHeader::SetHopCount(uint8_t count) [member function]
    cls.add_method('SetHopCount', 
                   'void', 
                   [param('uint8_t', 'count')])
    ## ncpr-packet.h (module 'ncpr'): void ns3::ncpr::RreqHeader::SetId(uint32_t id) [member function]
    cls.add_method('SetId', 
                   'void', 
                   [param('uint32_t', 'id')])
    ## ncpr-packet.h (module 'ncpr'): void ns3::ncpr::RreqHeader::SetOrigin(ns3::Ipv4Address a) [member function]
    cls.add_method('SetOrigin', 
                   'void', 
                   [param('ns3::Ipv4Address', 'a')])
    ## ncpr-packet.h (module 'ncpr'): void ns3::ncpr::RreqHeader::SetOriginSeqno(uint32_t s) [member function]
    cls.add_method('SetOriginSeqno', 
                   'void', 
                   [param('uint32_t', 's')])
    ## ncpr-packet.h (module 'ncpr'): void ns3::ncpr::RreqHeader::SetUnknownSeqno(bool f) [member function]
    cls.add_method('SetUnknownSeqno', 
                   'void', 
                   [param('bool', 'f')])
    return

def register_Ns3ncprTypeHeader_methods(root_module, cls):
    cls.add_output_stream_operator()
    cls.add_binary_comparison_operator('==')
    ## ncpr-packet.h (module 'ncpr'): ns3::ncpr::TypeHeader::TypeHeader(ns3::ncpr::TypeHeader const & arg0) [constructor]
    cls.add_constructor([param('ns3::ncpr::TypeHeader const &', 'arg0')])
    ## ncpr-packet.h (module 'ncpr'): ns3::ncpr::TypeHeader::TypeHeader(ns3::ncpr::MessageType t=::ns3::ncpr::MessageType::ncprTYPE_RREQ) [constructor]
    cls.add_constructor([param('ns3::ncpr::MessageType', 't', default_value='::ns3::ncpr::MessageType::ncprTYPE_RREQ')])
    ## ncpr-packet.h (module 'ncpr'): uint32_t ns3::ncpr::TypeHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## ncpr-packet.h (module 'ncpr'): ns3::ncpr::MessageType ns3::ncpr::TypeHeader::Get() const [member function]
    cls.add_method('Get', 
                   'ns3::ncpr::MessageType', 
                   [], 
                   is_const=True)
    ## ncpr-packet.h (module 'ncpr'): ns3::TypeId ns3::ncpr::TypeHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## ncpr-packet.h (module 'ncpr'): uint32_t ns3::ncpr::TypeHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## ncpr-packet.h (module 'ncpr'): static ns3::TypeId ns3::ncpr::TypeHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## ncpr-packet.h (module 'ncpr'): bool ns3::ncpr::TypeHeader::IsValid() const [member function]
    cls.add_method('IsValid', 
                   'bool', 
                   [], 
                   is_const=True)
    ## ncpr-packet.h (module 'ncpr'): void ns3::ncpr::TypeHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## ncpr-packet.h (module 'ncpr'): void ns3::ncpr::TypeHeader::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
...
def register_functions(root_module):
    ...
    register_functions_ns3_ncpr(module.add_cpp_namespace('ncpr'), root_module)
    return
...
def register_functions_ns3_ncpr(module, root_module):
    return
