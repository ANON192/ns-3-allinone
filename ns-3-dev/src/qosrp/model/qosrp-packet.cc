...
{
  static TypeId tid = TypeId ("ns3::qosrp::TypeHeader")
    .SetParent<Header> ()
    .SetGroupName ("qosrp")
...
{
  static TypeId tid = TypeId ("ns3::qosrp::RreqHeader")
    .SetParent<Header> ()
    .SetGroupName ("qosrp")
...
{
  static TypeId tid = TypeId ("ns3::qosrp::RrepHeader")
    .SetParent<Header> ()
    .SetGroupName ("qosrp")
...
{
  static TypeId tid = TypeId ("ns3::qosrp::RrepAckHeader")
    .SetParent<Header> ()
    .SetGroupName ("qosrp")
...
{
  static TypeId tid = TypeId ("ns3::qosrp::RerrHeader")
    .SetParent<Header> ()
    .SetGroupName ("qosrp")
