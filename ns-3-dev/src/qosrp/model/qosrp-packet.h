 ...
 */
#ifndef qosrpPACKET_H
#define qosrpPACKET_H
...
enum MessageType
{
  qosrpTYPE_RREQ  = 1,   //!< qosrpTYPE_RREQ
  qosrpTYPE_RREP  = 2,   //!< qosrpTYPE_RREP
  qosrpTYPE_RERR  = 3,   //!< qosrpTYPE_RERR
  qosrpTYPE_RREP_ACK = 4 //!< qosrpTYPE_RREP_ACK
};
...
public:
  /**
   * constructor
   * \param t the qosrp RREQ type
   */
  TypeHeader (MessageType t = qosrpTYPE_RREQ);
