 ...
 */
#ifndef qosrpROUTINGPROTOCOL_H
#define qosrpROUTINGPROTOCOL_H

#include "qosrp-rtable.h"
#include "qosrp-rqueue.h"
...
public:
  ...
  static const uint32_t qosrp_PORT;
...
private:
  ...
  void Recvqosrp (Ptr<Socket> socket);
  /// Receive RREQ
