 ...
 */
#ifndef qosrp_RQUEUE_H
#define qosrp_RQUEUE_H
...
/**
 * \ingroup qosrp
 * \brief qosrp route request queue
 *
 * Since qosrp is an on demand routing we queue requests while looking for route.
 */
class RequestQueue
{
public:
