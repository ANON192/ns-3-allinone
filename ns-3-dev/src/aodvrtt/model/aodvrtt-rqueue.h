 ...
 */
#ifndef aodvrtt_RQUEUE_H
#define aodvrtt_RQUEUE_H
...
/**
 * \ingroup aodvrtt
 * \brief aodvrtt route request queue
 *
 * Since aodvrtt is an on demand routing we queue requests while looking for route.
 */
class RequestQueue
{
public:
