 ...
 */
#ifndef aodvrttPACKET_H
#define aodvrttPACKET_H
...
enum MessageType
{
  aodvrttTYPE_RREQ  = 1,   //!< aodvrttTYPE_RREQ
  aodvrttTYPE_RREP  = 2,   //!< aodvrttTYPE_RREP
  aodvrttTYPE_RERR  = 3,   //!< aodvrttTYPE_RERR
  aodvrttTYPE_RREP_ACK = 4 //!< aodvrttTYPE_RREP_ACK
};
...
public:
  /**
   * constructor
   * \param t the aodvrtt RREQ type
   */
  TypeHeader (MessageType t = aodvrttTYPE_RREQ);
