...
{
  static TypeId tid = TypeId ("ns3::aodvrtt::TypeHeader")
    .SetParent<Header> ()
...
{
  static TypeId tid = TypeId ("ns3::aodvrtt::RreqHeader")
    .SetParent<Header> ()
    .SetGroupName ("aodvrtt")
...
{
  static TypeId tid = TypeId ("ns3::aodvrtt::RrepHeader")
    .SetParent<Header> ()
    .SetGroupName ("aodvrtt")
...
{
  static TypeId tid = TypeId ("ns3::aodvrtt::RrepAckHeader")
    .SetParent<Header> ()
    .SetGroupName ("aodvrtt")
...
{
  static TypeId tid = TypeId ("ns3::aodvrtt::RerrHeader")
    .SetParent<Header> ()
    .SetGroupName ("aodvrtt")
