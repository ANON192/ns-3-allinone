...
#include "newprotocol-packet.h"
#include "ns3/address-utils.h"
#include "ns3/packet.h"
#include "newprotocol-neighbor.h"
#include <set>
#include <array>
#include <list>
#include <iostream>
...
{
  static TypeId tid = TypeId ("ns3::newprotocol::TypeHeader")
    .SetParent<Header> ()
...
Ptr<MobilityModel>
RreqHeader::GetMobility()
{
  return senderModelss;
}
void
RreqHeader::SetMobility(Ptr<MobilityModel> setModel)
{
  senderModelss = setModel;
}
...
{
  static TypeId tid = TypeId ("ns3::newprotocol::RreqHeader")
    .SetParent<Header> ()
    .SetGroupName ("newprotocol")
...
{
  static TypeId tid = TypeId ("ns3::newprotocol::RrepHeader")
    .SetParent<Header> ()
    .SetGroupName ("newprotocol")
...
{
  static TypeId tid = TypeId ("ns3::newprotocol::RrepAckHeader")
    .SetParent<Header> ()
    .SetGroupName ("newprotocol")
...
{
  static TypeId tid = TypeId ("ns3::newprotocol::RerrHeader")
    .SetParent<Header> ()
    .SetGroupName ("newprotocol")
