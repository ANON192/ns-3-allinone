...
NS_LOG_COMPONENT_DEFINE ("newprotocolNeighbors");
          ...
          if (i->m_hardwareAddress == Mac48Address ())
            {
              ...
              this->NodeAddCoveredNeighbors(addr);
            }
          return;
        }
    }
...
list<Ipv4Address>NodeCovoredNeighborList={};

Ipv4Address
Neighbors::NodeGetCoveredNeighbors ()
{
  return NodeCovoredNeighborList.front();
}

int
Neighbors::NodeGetCoveredNeighborsLength ()
{
  return NodeCovoredNeighborList.size();
}

void
Neighbors::NodeAddCoveredNeighbors (Ipv4Address p)
{
  NodeCovoredNeighborList.push_front(p); 
}
