...
#ifndef newprotocolNEIGHBOR_H
#define newprotocolNEIGHBOR_H
...
public:
  ...
  void NodeAddCoveredNeighbors(Ipv4Address p);
  int NodeGetCoveredNeighborsLength();
  Ipv4Address NodeGetCoveredNeighbors();
