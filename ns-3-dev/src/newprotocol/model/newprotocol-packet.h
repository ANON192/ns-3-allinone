 ...
 */
#ifndef newprotocolPACKET_H
#define newprotocolPACKET_H
...
enum MessageType
{
  newprotocolTYPE_RREQ  = 1,   //!< newprotocolTYPE_RREQ
  newprotocolTYPE_RREP  = 2,   //!< newprotocolTYPE_RREP
  newprotocolTYPE_RERR  = 3,   //!< newprotocolTYPE_RERR
  newprotocolTYPE_RREP_ACK = 4 //!< newprotocolTYPE_RREP_ACK
};

/**
* \ingroup newprotocol
* \brief newprotocol types
*/
...
public:
  /**
   * constructor
   * \param t the newprotocol RREQ type
   */
  TypeHeader (MessageType t = newprotocolTYPE_RREQ);
...
public:
  ...
  int GetCountingHops();
  void SetCountingHops(int count);

  double GetSumPPT();
  void SetSumPPT(double ppt);

  Time GetPPT();
  void SetPPT(Time ppt);

  Ptr<Ipv4> GetPrevIpv4();
  void SetPrevIpv4(Ptr<Ipv4> m_ipv4);

  Ptr<MobilityModel> GetMobility();
  void SetMobility(Ptr<MobilityModel> setModel);
