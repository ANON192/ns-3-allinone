 ...
 */
#ifndef newprotocol_RQUEUE_H
#define newprotocol_RQUEUE_H
...
/**
 * \ingroup newprotocol
 * \brief newprotocol route request queue
 *
 * Since newprotocol is an on demand routing we queue requests while looking for route.
 */
class RequestQueue
{
public:
