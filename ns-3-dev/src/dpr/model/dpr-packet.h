...
enum MessageType
{
  dprTYPE_RREQ  = 1,   //!< dprTYPE_RREQ
  dprTYPE_RREP  = 2,   //!< dprTYPE_RREP
  dprTYPE_RERR  = 3,   //!< dprTYPE_RERR
  dprTYPE_RREP_ACK = 4 //!< dprTYPE_RREP_ACK
};
...
public:
  /**
   * constructor
   * \param t the dpr RREQ type
   */
  TypeHeader (MessageType t = dprTYPE_RREQ);
