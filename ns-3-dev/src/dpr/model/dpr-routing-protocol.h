 ...
 */
#ifndef dprROUTINGPROTOCOL_H
#define dprROUTINGPROTOCOL_H

#include "dpr-rtable.h"
#include "dpr-rqueue.h"
...
public:
  ...
  static const uint32_t dpr_PORT;
...
private:
  ...
  void Recvdpr (Ptr<Socket> socket);
  /// Receive RREQ
