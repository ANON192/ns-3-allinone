 ...
 */
#include "dpr-packet.h"
#include "ns3/address-utils.h"
#include "ns3/packet.h"
#include "dpr-neighbor.h"
#include <set>
#include <array>
#include <list>
#include <iostream>
...
{
  static TypeId tid = TypeId ("ns3::dpr::RreqHeader")
    .SetParent<Header> ()
    .SetGroupName ("dpr")
...
{
  static TypeId tid = TypeId ("ns3::dpr::RrepHeader")
    .SetParent<Header> ()
    .SetGroupName ("dpr")
...
{
  static TypeId tid = TypeId ("ns3::dpr::RrepAckHeader")
    .SetParent<Header> ()
    .SetGroupName ("dpr")
...
{
  static TypeId tid = TypeId ("ns3::dpr::RerrHeader")
    .SetParent<Header> ()
    .SetGroupName ("dpr")
