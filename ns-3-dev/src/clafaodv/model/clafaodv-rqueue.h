 ...
 */
#ifndef clafaodv_RQUEUE_H
#define clafaodv_RQUEUE_H
...
/**
 * \ingroup clafaodv
 * \brief clafaodv route request queue
 *
 * Since clafaodv is an on demand routing we queue requests while looking for route.
 */
class RequestQueue
{
public:
