...
#include "clafaodv-packet.h"
#include "ns3/address-utils.h"
#include "ns3/packet.h"
#include "clafaodv-neighbor.h"
#include <set>
#include <array>
#include <list>
#include <iostream>
...
{
  static TypeId tid = TypeId ("ns3::clafaodv::TypeHeader")
    .SetParent<Header> ()
...
{
  static TypeId tid = TypeId ("ns3::clafaodv::RreqHeader")
    .SetParent<Header> ()
    .SetGroupName ("clafaodv")
...
{
  static TypeId tid = TypeId ("ns3::clafaodv::RrepHeader")
    .SetParent<Header> ()
    .SetGroupName ("clafaodv")
...
{
  static TypeId tid = TypeId ("ns3::clafaodv::RrepAckHeader")
    .SetParent<Header> ()
    .SetGroupName ("clafaodv")
...
{
  static TypeId tid = TypeId ("ns3::clafaodv::RerrHeader")
    .SetParent<Header> ()
    .SetGroupName ("clafaodv")
