 ...
 */
#ifndef clafaodvPACKET_H
#define clafaodvPACKET_H
...
enum MessageType
{
  clafaodvTYPE_RREQ  = 1,   //!< clafaodvTYPE_RREQ
  clafaodvTYPE_RREP  = 2,   //!< clafaodvTYPE_RREP
  clafaodvTYPE_RERR  = 3,   //!< clafaodvTYPE_RERR
  clafaodvTYPE_RREP_ACK = 4 //!< clafaodvTYPE_RREP_ACK
};

/**
* \ingroup clafaodv
* \brief clafaodv types
*/
...
public:
  /**
   * constructor
   * \param t the clafaodv RREQ type
   */
  TypeHeader (MessageType t = clafaodvTYPE_RREQ);
