...
enum MessageType
{
  ncprTYPE_RREQ  = 1,   //!< ncprTYPE_RREQ
  ncprTYPE_RREP  = 2,   //!< ncprTYPE_RREP
  ncprTYPE_RERR  = 3,   //!< ncprTYPE_RERR
  ncprTYPE_RREP_ACK = 4 //!< ncprTYPE_RREP_ACK
};
...
public:
  /**
   * constructor
   * \param t the ncpr RREQ type
   */
  TypeHeader (MessageType t = ncprTYPE_RREQ);
