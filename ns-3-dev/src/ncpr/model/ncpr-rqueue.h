 ...
 */
#ifndef ncpr_RQUEUE_H
#define ncpr_RQUEUE_H
...
/**
 * \ingroup ncpr
 * \brief ncpr route request queue
 *
 * Since ncpr is an on demand routing we queue requests while looking for route.
 */
class RequestQueue
{
public:
