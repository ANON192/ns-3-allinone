 ...
 */
#ifndef ncprROUTINGPROTOCOL_H
#define ncprROUTINGPROTOCOL_H

#include "ncpr-rtable.h"
#include "ncpr-rqueue.h"
...
public:
  ...
  static const uint32_t ncpr_PORT;
...
private:
  ...
  void Recvncpr (Ptr<Socket> socket);
  /// Receive RREQ
