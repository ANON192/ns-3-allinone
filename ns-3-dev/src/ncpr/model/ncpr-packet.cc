...
{
  static TypeId tid = TypeId ("ns3::ncpr::TypeHeader")
    .SetParent<Header> ()
    .SetGroupName ("ncpr")
...
{
  static TypeId tid = TypeId ("ns3::ncpr::RreqHeader")
    .SetParent<Header> ()
    .SetGroupName ("ncpr")
...
{
  static TypeId tid = TypeId ("ns3::ncpr::RrepHeader")
    .SetParent<Header> ()
    .SetGroupName ("ncpr")
...
{
  static TypeId tid = TypeId ("ns3::ncpr::RrepAckHeader")
    .SetParent<Header> ()
    .SetGroupName ("ncpr")
...
{
  static TypeId tid = TypeId ("ns3::ncpr::RerrHeader")
    .SetParent<Header> ()
    .SetGroupName ("ncpr")
