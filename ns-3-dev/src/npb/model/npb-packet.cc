...
{
  static TypeId tid = TypeId ("ns3::npb::TypeHeader")
    .SetParent<Header> ()
    .SetGroupName ("npb")
...
{
  static TypeId tid = TypeId ("ns3::npb::RreqHeader")
    .SetParent<Header> ()
    .SetGroupName ("npb")
...
{
  static TypeId tid = TypeId ("ns3::npb::RrepHeader")
    .SetParent<Header> ()
    .SetGroupName ("npb")
...
{
  static TypeId tid = TypeId ("ns3::npb::RrepAckHeader")
    .SetParent<Header> ()
    .SetGroupName ("npb")
...
{
  static TypeId tid = TypeId ("ns3::npb::RerrHeader")
    .SetParent<Header> ()
    .SetGroupName ("npb")
