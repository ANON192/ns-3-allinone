...
enum MessageType
{
  npbTYPE_RREQ  = 1,   //!< npbTYPE_RREQ
  npbTYPE_RREP  = 2,   //!< npbTYPE_RREP
  npbTYPE_RERR  = 3,   //!< npbTYPE_RERR
  npbTYPE_RREP_ACK = 4 //!< npbTYPE_RREP_ACK
};
...
public:
  /**
   * constructor
   * \param t the npb RREQ type
   */
  TypeHeader (MessageType t = npbTYPE_RREQ);
