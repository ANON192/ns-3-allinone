 ...
 */
#ifndef npbROUTINGPROTOCOL_H
#define npbROUTINGPROTOCOL_H

#include "npb-rtable.h"
#include "npb-rqueue.h"
...
public:
  ...
  static const uint32_t npb_PORT;
...
private:
  ...
  void Recvnpb (Ptr<Socket> socket);
  /// Receive RREQ
