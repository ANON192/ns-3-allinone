...
enum MessageType
{
  dcfpTYPE_RREQ  = 1,   //!< dcfpTYPE_RREQ
  dcfpTYPE_RREP  = 2,   //!< dcfpTYPE_RREP
  dcfpTYPE_RERR  = 3,   //!< dcfpTYPE_RERR
  dcfpTYPE_RREP_ACK = 4 //!< dcfpTYPE_RREP_ACK
};
...
public:
  /**
   * constructor
   * \param t the dcfp RREQ type
   */
  TypeHeader (MessageType t = dcfpTYPE_RREQ);
