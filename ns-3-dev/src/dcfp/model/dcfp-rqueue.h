 ...
 */
#ifndef dcfp_RQUEUE_H
#define dcfp_RQUEUE_H
...
/**
 * \ingroup dcfp
 * \brief dcfp route request queue
 *
 * Since dcfp is an on demand routing we queue requests while looking for route.
 */
class RequestQueue
{
public:
