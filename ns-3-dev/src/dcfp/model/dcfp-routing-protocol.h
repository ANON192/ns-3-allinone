 ...
 */
#ifndef dcfpROUTINGPROTOCOL_H
#define dcfpROUTINGPROTOCOL_H

#include "dcfp-rtable.h"
#include "dcfp-rqueue.h"
...
public:
  ...
  static const uint32_t dcfp_PORT;
...
private:
  ...
  void Recvdcfp (Ptr<Socket> socket);
  /// Receive RREQ
