...
{
  static TypeId tid = TypeId ("ns3::dcfp::TypeHeader")
    .SetParent<Header> ()
    .SetGroupName ("dcfp")
...
{
  static TypeId tid = TypeId ("ns3::dcfp::RreqHeader")
    .SetParent<Header> ()
    .SetGroupName ("dcfp")
...
{
  static TypeId tid = TypeId ("ns3::dcfp::RrepHeader")
    .SetParent<Header> ()
    .SetGroupName ("dcfp")
...
{
  static TypeId tid = TypeId ("ns3::dcfp::RrepAckHeader")
    .SetParent<Header> ()
    .SetGroupName ("dcfp")
...
{
  static TypeId tid = TypeId ("ns3::dcfp::RerrHeader")
    .SetParent<Header> ()
    .SetGroupName ("dcfp")
