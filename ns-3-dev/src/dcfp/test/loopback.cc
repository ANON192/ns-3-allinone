 ...
 * \ingroup dcfp
 *
 * \brief dcfp loopback UDP echo test case
 */
 ...
 * \ingroup tests
 *
 * \brief dcfp Loopback test suite
 */
class dcfpLoopbackTestSuite : public TestSuite
{
public:
  dcfpLoopbackTestSuite () : TestSuite ("routing-dcfp-loopback", SYSTEM)
  {
    SetDataDir (NS_TEST_SOURCEDIR);
    // UDP Echo loopback test case
    AddTestCase (new LoopbackTestCase (), TestCase::QUICK);
  }
} g_dcfpLoopbackTestSuite; ///< the test suite
