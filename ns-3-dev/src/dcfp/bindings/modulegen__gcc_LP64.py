...
def module_init():
    root_module = Module('ns.dcfp', cpp_namespace='::ns3')
    return root_module
...
def register_types(module):
    ...
    ## dcfp-helper.h (module 'dcfp'): ns3::dcfpHelper [class]
    module.add_class('dcfpHelper', parent=root_module['ns3::Ipv4RoutingHelper'])
    ...
    ## Register a nested module for the namespace dcfp
    
    nested_module = module.add_cpp_namespace('dcfp')
    register_types_ns3_dcfp(nested_module)
...
def register_types_ns3_dcfp(module):
    root_module = module.get_root()
    
    ## dcfp-rtable.h (module 'dcfp'): ns3::dcfp::RouteFlags [enumeration]
    module.add_enum('RouteFlags', ['VALID', 'INVALID', 'IN_SEARCH'])
    ## dcfp-packet.h (module 'dcfp'): ns3::dcfp::MessageType [enumeration]
    module.add_enum('MessageType', ['dcfpTYPE_RREQ', 'dcfpTYPE_RREP', 'dcfpTYPE_RERR', 'dcfpTYPE_RREP_ACK'])
    ## dcfp-dpd.h (module 'dcfp'): ns3::dcfp::DuplicatePacketDetection [class]
    module.add_class('DuplicatePacketDetection')
    ## dcfp-id-cache.h (module 'dcfp'): ns3::dcfp::IdCache [class]
    module.add_class('IdCache')
    ## dcfp-neighbor.h (module 'dcfp'): ns3::dcfp::Neighbors [class]
    module.add_class('Neighbors')
    ## dcfp-neighbor.h (module 'dcfp'): ns3::dcfp::Neighbors::Neighbor [struct]
    module.add_class('Neighbor', outer_class=root_module['ns3::dcfp::Neighbors'])
    ## dcfp-rqueue.h (module 'dcfp'): ns3::dcfp::QueueEntry [class]
    module.add_class('QueueEntry')
    typehandlers.add_type_alias(u'ns3::Ipv4RoutingProtocol::UnicastForwardCallback', u'ns3::dcfp::QueueEntry::UnicastForwardCallback')
    typehandlers.add_type_alias(u'ns3::Ipv4RoutingProtocol::UnicastForwardCallback*', u'ns3::dcfp::QueueEntry::UnicastForwardCallback*')
    typehandlers.add_type_alias(u'ns3::Ipv4RoutingProtocol::UnicastForwardCallback&', u'ns3::dcfp::QueueEntry::UnicastForwardCallback&')
    typehandlers.add_type_alias(u'ns3::Ipv4RoutingProtocol::ErrorCallback', u'ns3::dcfp::QueueEntry::ErrorCallback')
    typehandlers.add_type_alias(u'ns3::Ipv4RoutingProtocol::ErrorCallback*', u'ns3::dcfp::QueueEntry::ErrorCallback*')
    typehandlers.add_type_alias(u'ns3::Ipv4RoutingProtocol::ErrorCallback&', u'ns3::dcfp::QueueEntry::ErrorCallback&')
    ## dcfp-rqueue.h (module 'dcfp'): ns3::dcfp::RequestQueue [class]
    module.add_class('RequestQueue')
    ## dcfp-packet.h (module 'dcfp'): ns3::dcfp::RerrHeader [class]
    module.add_class('RerrHeader', parent=root_module['ns3::Header'])
    ## dcfp-routing-protocol.h (module 'dcfp'): ns3::dcfp::RoutingProtocol [class]
    module.add_class('RoutingProtocol', parent=root_module['ns3::Ipv4RoutingProtocol'])
    ## dcfp-rtable.h (module 'dcfp'): ns3::dcfp::RoutingTable [class]
    module.add_class('RoutingTable')
    ## dcfp-rtable.h (module 'dcfp'): ns3::dcfp::RoutingTableEntry [class]
    module.add_class('RoutingTableEntry')
    ## dcfp-packet.h (module 'dcfp'): ns3::dcfp::RrepAckHeader [class]
    module.add_class('RrepAckHeader', parent=root_module['ns3::Header'])
    ## dcfp-packet.h (module 'dcfp'): ns3::dcfp::RrepHeader [class]
    module.add_class('RrepHeader', parent=root_module['ns3::Header'])
    ## dcfp-packet.h (module 'dcfp'): ns3::dcfp::RreqHeader [class]
    module.add_class('RreqHeader', parent=root_module['ns3::Header'])
    ## dcfp-packet.h (module 'dcfp'): ns3::dcfp::TypeHeader [class]
...
def register_methods(root_module):
    ...
    register_Ns3dcfpHelper_methods(root_module, root_module['ns3::dcfpHelper'])
    ...
    register_Ns3dcfpDuplicatePacketDetection_methods(root_module, root_module['ns3::dcfp::DuplicatePacketDetection'])
    register_Ns3dcfpIdCache_methods(root_module, root_module['ns3::dcfp::IdCache'])
    register_Ns3dcfpNeighbors_methods(root_module, root_module['ns3::dcfp::Neighbors'])
    register_Ns3dcfpNeighborsNeighbor_methods(root_module, root_module['ns3::dcfp::Neighbors::Neighbor'])
    register_Ns3dcfpQueueEntry_methods(root_module, root_module['ns3::dcfp::QueueEntry'])
    register_Ns3dcfpRequestQueue_methods(root_module, root_module['ns3::dcfp::RequestQueue'])
    register_Ns3dcfpRerrHeader_methods(root_module, root_module['ns3::dcfp::RerrHeader'])
    register_Ns3dcfpRoutingProtocol_methods(root_module, root_module['ns3::dcfp::RoutingProtocol'])
    register_Ns3dcfpRoutingTable_methods(root_module, root_module['ns3::dcfp::RoutingTable'])
    register_Ns3dcfpRoutingTableEntry_methods(root_module, root_module['ns3::dcfp::RoutingTableEntry'])
    register_Ns3dcfpRrepAckHeader_methods(root_module, root_module['ns3::dcfp::RrepAckHeader'])
    register_Ns3dcfpRrepHeader_methods(root_module, root_module['ns3::dcfp::RrepHeader'])
    register_Ns3dcfpRreqHeader_methods(root_module, root_module['ns3::dcfp::RreqHeader'])
    register_Ns3dcfpTypeHeader_methods(root_module, root_module['ns3::dcfp::TypeHeader'])
    return
...
def register_Ns3dcfpHelper_methods(root_module, cls):
    ## dcfp-helper.h (module 'dcfp'): ns3::dcfpHelper::dcfpHelper(ns3::dcfpHelper const & arg0) [constructor]
    cls.add_constructor([param('ns3::dcfpHelper const &', 'arg0')])
    ## dcfp-helper.h (module 'dcfp'): ns3::dcfpHelper::dcfpHelper() [constructor]
    cls.add_constructor([])
    ## dcfp-helper.h (module 'dcfp'): int64_t ns3::dcfpHelper::AssignStreams(ns3::NodeContainer c, int64_t stream) [member function]
    cls.add_method('AssignStreams', 
                   'int64_t', 
                   [param('ns3::NodeContainer', 'c'), param('int64_t', 'stream')])
    ## dcfp-helper.h (module 'dcfp'): ns3::dcfpHelper * ns3::dcfpHelper::Copy() const [member function]
    cls.add_method('Copy', 
                   'ns3::dcfpHelper *', 
                   [], 
                   is_const=True, is_virtual=True)
    ## dcfp-helper.h (module 'dcfp'): ns3::Ptr<ns3::Ipv4RoutingProtocol> ns3::dcfpHelper::Create(ns3::Ptr<ns3::Node> node) const [member function]
    cls.add_method('Create', 
                   'ns3::Ptr< ns3::Ipv4RoutingProtocol >', 
                   [param('ns3::Ptr< ns3::Node >', 'node')], 
                   is_const=True, is_virtual=True)
    ## dcfp-helper.h (module 'dcfp'): void ns3::dcfpHelper::Set(std::string name, ns3::AttributeValue const & value) [member function]
    cls.add_method('Set', 
                   'void', 
                   [param('std::string', 'name'), param('ns3::AttributeValue const &', 'value')])
    return
...
def register_Ns3dcfpDuplicatePacketDetection_methods(root_module, cls):
    ## dcfp-dpd.h (module 'dcfp'): ns3::dcfp::DuplicatePacketDetection::DuplicatePacketDetection(ns3::dcfp::DuplicatePacketDetection const & arg0) [constructor]
    cls.add_constructor([param('ns3::dcfp::DuplicatePacketDetection const &', 'arg0')])
    ## dcfp-dpd.h (module 'dcfp'): ns3::dcfp::DuplicatePacketDetection::DuplicatePacketDetection(ns3::Time lifetime) [constructor]
    cls.add_constructor([param('ns3::Time', 'lifetime')])
    ## dcfp-dpd.h (module 'dcfp'): ns3::Time ns3::dcfp::DuplicatePacketDetection::GetLifetime() const [member function]
    cls.add_method('GetLifetime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## dcfp-dpd.h (module 'dcfp'): bool ns3::dcfp::DuplicatePacketDetection::IsDuplicate(ns3::Ptr<const ns3::Packet> p, ns3::Ipv4Header const & header) [member function]
    cls.add_method('IsDuplicate', 
                   'bool', 
                   [param('ns3::Ptr< ns3::Packet const >', 'p'), param('ns3::Ipv4Header const &', 'header')])
    ## dcfp-dpd.h (module 'dcfp'): void ns3::dcfp::DuplicatePacketDetection::SetLifetime(ns3::Time lifetime) [member function]
    cls.add_method('SetLifetime', 
                   'void', 
                   [param('ns3::Time', 'lifetime')])
    return

def register_Ns3dcfpIdCache_methods(root_module, cls):
    ## dcfp-id-cache.h (module 'dcfp'): ns3::dcfp::IdCache::IdCache(ns3::dcfp::IdCache const & arg0) [constructor]
    cls.add_constructor([param('ns3::dcfp::IdCache const &', 'arg0')])
    ## dcfp-id-cache.h (module 'dcfp'): ns3::dcfp::IdCache::IdCache(ns3::Time lifetime) [constructor]
    cls.add_constructor([param('ns3::Time', 'lifetime')])
    ## dcfp-id-cache.h (module 'dcfp'): ns3::Time ns3::dcfp::IdCache::GetLifeTime() const [member function]
    cls.add_method('GetLifeTime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## dcfp-id-cache.h (module 'dcfp'): uint32_t ns3::dcfp::IdCache::GetSize() [member function]
    cls.add_method('GetSize', 
                   'uint32_t', 
                   [])
    ## dcfp-id-cache.h (module 'dcfp'): bool ns3::dcfp::IdCache::IsDuplicate(ns3::Ipv4Address addr, uint32_t id) [member function]
    cls.add_method('IsDuplicate', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'addr'), param('uint32_t', 'id')])
    ## dcfp-id-cache.h (module 'dcfp'): void ns3::dcfp::IdCache::Purge() [member function]
    cls.add_method('Purge', 
                   'void', 
                   [])
    ## dcfp-id-cache.h (module 'dcfp'): void ns3::dcfp::IdCache::SetLifetime(ns3::Time lifetime) [member function]
    cls.add_method('SetLifetime', 
                   'void', 
                   [param('ns3::Time', 'lifetime')])
    return

def register_Ns3dcfpNeighbors_methods(root_module, cls):
    ## dcfp-neighbor.h (module 'dcfp'): ns3::dcfp::Neighbors::Neighbors(ns3::dcfp::Neighbors const & arg0) [constructor]
    cls.add_constructor([param('ns3::dcfp::Neighbors const &', 'arg0')])
    ## dcfp-neighbor.h (module 'dcfp'): ns3::dcfp::Neighbors::Neighbors(ns3::Time delay) [constructor]
    cls.add_constructor([param('ns3::Time', 'delay')])
    ## dcfp-neighbor.h (module 'dcfp'): void ns3::dcfp::Neighbors::AddArpCache(ns3::Ptr<ns3::ArpCache> a) [member function]
    cls.add_method('AddArpCache', 
                   'void', 
                   [param('ns3::Ptr< ns3::ArpCache >', 'a')])
    ## dcfp-neighbor.h (module 'dcfp'): void ns3::dcfp::Neighbors::Clear() [member function]
    cls.add_method('Clear', 
                   'void', 
                   [])
    ## dcfp-neighbor.h (module 'dcfp'): void ns3::dcfp::Neighbors::DelArpCache(ns3::Ptr<ns3::ArpCache> a) [member function]
    cls.add_method('DelArpCache', 
                   'void', 
                   [param('ns3::Ptr< ns3::ArpCache >', 'a')])
    ## dcfp-neighbor.h (module 'dcfp'): ns3::Callback<void, ns3::Ipv4Address, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty> ns3::dcfp::Neighbors::GetCallback() const [member function]
    cls.add_method('GetCallback', 
                   ...
                   [], 
                   is_const=True)
    ## dcfp-neighbor.h (module 'dcfp'): ns3::Time ns3::dcfp::Neighbors::GetExpireTime(ns3::Ipv4Address addr) [member function]
    cls.add_method('GetExpireTime', 
                   'ns3::Time', 
                   [param('ns3::Ipv4Address', 'addr')])
    ## dcfp-neighbor.h (module 'dcfp'): ns3::Callback<void, const ns3::WifiMacHeader &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty> ns3::dcfp::Neighbors::GetTxErrorCallback() const [member function]
    cls.add_method('GetTxErrorCallback', 
                   ...
                   [], 
                   is_const=True)
    ## dcfp-neighbor.h (module 'dcfp'): bool ns3::dcfp::Neighbors::IsNeighbor(ns3::Ipv4Address addr) [member function]
    cls.add_method('IsNeighbor', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'addr')])
    ## dcfp-neighbor.h (module 'dcfp'): void ns3::dcfp::Neighbors::Purge() [member function]
    cls.add_method('Purge', 
                   'void', 
                   [])
    ## dcfp-neighbor.h (module 'dcfp'): void ns3::dcfp::Neighbors::ScheduleTimer() [member function]
    cls.add_method('ScheduleTimer', 
                   'void', 
                   [])
    ## dcfp-neighbor.h (module 'dcfp'): void ns3::dcfp::Neighbors::SetCallback(ns3::Callback<void, ns3::Ipv4Address, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty> cb) [member function]
    ...
    ## dcfp-neighbor.h (module 'dcfp'): void ns3::dcfp::Neighbors::Update(ns3::Ipv4Address addr, ns3::Time expire) [member function]
    cls.add_method('Update', 
                   'void', 
                   [param('ns3::Ipv4Address', 'addr'), param('ns3::Time', 'expire')])
    return

def register_Ns3dcfpNeighborsNeighbor_methods(root_module, cls):
    ## dcfp-neighbor.h (module 'dcfp'): ns3::dcfp::Neighbors::Neighbor::Neighbor(ns3::dcfp::Neighbors::Neighbor const & arg0) [constructor]
    cls.add_constructor([param('ns3::dcfp::Neighbors::Neighbor const &', 'arg0')])
    ## dcfp-neighbor.h (module 'dcfp'): ns3::dcfp::Neighbors::Neighbor::Neighbor(ns3::Ipv4Address ip, ns3::Mac48Address mac, ns3::Time t) [constructor]
    cls.add_constructor([param('ns3::Ipv4Address', 'ip'), param('ns3::Mac48Address', 'mac'), param('ns3::Time', 't')])
    ## dcfp-neighbor.h (module 'dcfp'): ns3::dcfp::Neighbors::Neighbor::close [variable]
    cls.add_instance_attribute('close', 'bool', is_const=False)
    ## dcfp-neighbor.h (module 'dcfp'): ns3::dcfp::Neighbors::Neighbor::m_expireTime [variable]
    cls.add_instance_attribute('m_expireTime', 'ns3::Time', is_const=False)
    ## dcfp-neighbor.h (module 'dcfp'): ns3::dcfp::Neighbors::Neighbor::m_hardwareAddress [variable]
    cls.add_instance_attribute('m_hardwareAddress', 'ns3::Mac48Address', is_const=False)
    ## dcfp-neighbor.h (module 'dcfp'): ns3::dcfp::Neighbors::Neighbor::m_neighborAddress [variable]
    cls.add_instance_attribute('m_neighborAddress', 'ns3::Ipv4Address', is_const=False)
    return

def register_Ns3dcfpQueueEntry_methods(root_module, cls):
    cls.add_binary_comparison_operator('==')
    ## dcfp-rqueue.h (module 'dcfp'): ns3::dcfp::QueueEntry::QueueEntry(ns3::dcfp::QueueEntry const & arg0) [constructor]
    cls.add_constructor([param('ns3::dcfp::QueueEntry const &', 'arg0')])
    ## dcfp-rqueue.h (module 'dcfp'): ns3::dcfp::QueueEntry::QueueEntry(ns3::Ptr<const ns3::Packet> pa=0, ns3::Ipv4Header const & h=ns3::Ipv4Header(), ns3::dcfp::QueueEntry::UnicastForwardCallback ucb=::ns3::Callback<void, ns3::Ptr<ns3::Ipv4Route>, ns3::Ptr<const ns3::Packet>, const ns3::Ipv4Header &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty>( ), ns3::dcfp::QueueEntry::ErrorCallback ecb=::ns3::Callback<void, ns3::Ptr<const ns3::Packet>, const ns3::Ipv4Header &, ns3::Socket::SocketErrno, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty>( ), ns3::Time exp=ns3::Simulator::Now()) [constructor]
    cls.add_constructor([param('ns3::Ptr< ns3::Packet const >', 'pa', default_value='0'), param('ns3::Ipv4Header const &', 'h', default_value='ns3::Ipv4Header()'), param('ns3::dcfp::QueueEntry::UnicastForwardCallback', 'ucb', default_value='::ns3::Callback<void, ns3::Ptr<ns3::Ipv4Route>, ns3::Ptr<const ns3::Packet>, const ns3::Ipv4Header &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty>( )'), param('ns3::dcfp::QueueEntry::ErrorCallback', 'ecb', default_value='::ns3::Callback<void, ns3::Ptr<const ns3::Packet>, const ns3::Ipv4Header &, ns3::Socket::SocketErrno, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty>( )'), param('ns3::Time', 'exp', default_value='ns3::Simulator::Now()')])
    ## dcfp-rqueue.h (module 'dcfp'): ns3::dcfp::QueueEntry::ErrorCallback ns3::dcfp::QueueEntry::GetErrorCallback() const [member function]
    cls.add_method('GetErrorCallback', 
                   'ns3::dcfp::QueueEntry::ErrorCallback', 
                   [], 
                   is_const=True)
    ## dcfp-rqueue.h (module 'dcfp'): ns3::Time ns3::dcfp::QueueEntry::GetExpireTime() const [member function]
    cls.add_method('GetExpireTime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## dcfp-rqueue.h (module 'dcfp'): ns3::Ipv4Header ns3::dcfp::QueueEntry::GetIpv4Header() const [member function]
    cls.add_method('GetIpv4Header', 
                   'ns3::Ipv4Header', 
                   [], 
                   is_const=True)
    ## dcfp-rqueue.h (module 'dcfp'): ns3::Ptr<const ns3::Packet> ns3::dcfp::QueueEntry::GetPacket() const [member function]
    cls.add_method('GetPacket', 
                   'ns3::Ptr< ns3::Packet const >', 
                   [], 
                   is_const=True)
    ## dcfp-rqueue.h (module 'dcfp'): ns3::dcfp::QueueEntry::UnicastForwardCallback ns3::dcfp::QueueEntry::GetUnicastForwardCallback() const [member function]
    cls.add_method('GetUnicastForwardCallback', 
                   'ns3::dcfp::QueueEntry::UnicastForwardCallback', 
                   [], 
                   is_const=True)
    ## dcfp-rqueue.h (module 'dcfp'): void ns3::dcfp::QueueEntry::SetErrorCallback(ns3::dcfp::QueueEntry::ErrorCallback ecb) [member function]
    cls.add_method('SetErrorCallback', 
                   'void', 
                   [param('ns3::Ipv4RoutingProtocol::ErrorCallback', 'ecb')])
    ## dcfp-rqueue.h (module 'dcfp'): void ns3::dcfp::QueueEntry::SetExpireTime(ns3::Time exp) [member function]
    cls.add_method('SetExpireTime', 
                   'void', 
                   [param('ns3::Time', 'exp')])
    ## dcfp-rqueue.h (module 'dcfp'): void ns3::dcfp::QueueEntry::SetIpv4Header(ns3::Ipv4Header h) [member function]
    cls.add_method('SetIpv4Header', 
                   'void', 
                   [param('ns3::Ipv4Header', 'h')])
    ## dcfp-rqueue.h (module 'dcfp'): void ns3::dcfp::QueueEntry::SetPacket(ns3::Ptr<const ns3::Packet> p) [member function]
    cls.add_method('SetPacket', 
                   'void', 
                   [param('ns3::Ptr< ns3::Packet const >', 'p')])
    ## dcfp-rqueue.h (module 'dcfp'): void ns3::dcfp::QueueEntry::SetUnicastForwardCallback(ns3::dcfp::QueueEntry::UnicastForwardCallback ucb) [member function]
    cls.add_method('SetUnicastForwardCallback', 
                   'void', 
                   [param('ns3::Ipv4RoutingProtocol::UnicastForwardCallback', 'ucb')])
    return

def register_Ns3dcfpRequestQueue_methods(root_module, cls):
    ## dcfp-rqueue.h (module 'dcfp'): ns3::dcfp::RequestQueue::RequestQueue(ns3::dcfp::RequestQueue const & arg0) [constructor]
    cls.add_constructor([param('ns3::dcfp::RequestQueue const &', 'arg0')])
    ## dcfp-rqueue.h (module 'dcfp'): ns3::dcfp::RequestQueue::RequestQueue(uint32_t maxLen, ns3::Time routeToQueueTimeout) [constructor]
    cls.add_constructor([param('uint32_t', 'maxLen'), param('ns3::Time', 'routeToQueueTimeout')])
    ## dcfp-rqueue.h (module 'dcfp'): bool ns3::dcfp::RequestQueue::Dequeue(ns3::Ipv4Address dst, ns3::dcfp::QueueEntry & entry) [member function]
    cls.add_method('Dequeue', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'dst'), param('ns3::dcfp::QueueEntry &', 'entry')])
    ## dcfp-rqueue.h (module 'dcfp'): void ns3::dcfp::RequestQueue::DropPacketWithDst(ns3::Ipv4Address dst) [member function]
    cls.add_method('DropPacketWithDst', 
                   'void', 
                   [param('ns3::Ipv4Address', 'dst')])
    ## dcfp-rqueue.h (module 'dcfp'): bool ns3::dcfp::RequestQueue::Enqueue(ns3::dcfp::QueueEntry & entry) [member function]
    cls.add_method('Enqueue', 
                   'bool', 
                   [param('ns3::dcfp::QueueEntry &', 'entry')])
    ## dcfp-rqueue.h (module 'dcfp'): bool ns3::dcfp::RequestQueue::Find(ns3::Ipv4Address dst) [member function]
    cls.add_method('Find', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'dst')])
    ## dcfp-rqueue.h (module 'dcfp'): uint32_t ns3::dcfp::RequestQueue::GetMaxQueueLen() const [member function]
    cls.add_method('GetMaxQueueLen', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## dcfp-rqueue.h (module 'dcfp'): ns3::Time ns3::dcfp::RequestQueue::GetQueueTimeout() const [member function]
    cls.add_method('GetQueueTimeout', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## dcfp-rqueue.h (module 'dcfp'): uint32_t ns3::dcfp::RequestQueue::GetSize() [member function]
    cls.add_method('GetSize', 
                   'uint32_t', 
                   [])
    ## dcfp-rqueue.h (module 'dcfp'): void ns3::dcfp::RequestQueue::SetMaxQueueLen(uint32_t len) [member function]
    cls.add_method('SetMaxQueueLen', 
                   'void', 
                   [param('uint32_t', 'len')])
    ## dcfp-rqueue.h (module 'dcfp'): void ns3::dcfp::RequestQueue::SetQueueTimeout(ns3::Time t) [member function]
    cls.add_method('SetQueueTimeout', 
                   'void', 
                   [param('ns3::Time', 't')])
    return

def register_Ns3dcfpRerrHeader_methods(root_module, cls):
    cls.add_output_stream_operator()
    cls.add_binary_comparison_operator('==')
    ## dcfp-packet.h (module 'dcfp'): ns3::dcfp::RerrHeader::RerrHeader(ns3::dcfp::RerrHeader const & arg0) [constructor]
    cls.add_constructor([param('ns3::dcfp::RerrHeader const &', 'arg0')])
    ## dcfp-packet.h (module 'dcfp'): ns3::dcfp::RerrHeader::RerrHeader() [constructor]
    cls.add_constructor([])
    ## dcfp-packet.h (module 'dcfp'): bool ns3::dcfp::RerrHeader::AddUnDestination(ns3::Ipv4Address dst, uint32_t seqNo) [member function]
    cls.add_method('AddUnDestination', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'dst'), param('uint32_t', 'seqNo')])
    ## dcfp-packet.h (module 'dcfp'): void ns3::dcfp::RerrHeader::Clear() [member function]
    cls.add_method('Clear', 
                   'void', 
                   [])
    ## dcfp-packet.h (module 'dcfp'): uint32_t ns3::dcfp::RerrHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## dcfp-packet.h (module 'dcfp'): uint8_t ns3::dcfp::RerrHeader::GetDestCount() const [member function]
    cls.add_method('GetDestCount', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## dcfp-packet.h (module 'dcfp'): ns3::TypeId ns3::dcfp::RerrHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## dcfp-packet.h (module 'dcfp'): bool ns3::dcfp::RerrHeader::GetNoDelete() const [member function]
    cls.add_method('GetNoDelete', 
                   'bool', 
                   [], 
                   is_const=True)
    ## dcfp-packet.h (module 'dcfp'): uint32_t ns3::dcfp::RerrHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## dcfp-packet.h (module 'dcfp'): static ns3::TypeId ns3::dcfp::RerrHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## dcfp-packet.h (module 'dcfp'): void ns3::dcfp::RerrHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## dcfp-packet.h (module 'dcfp'): bool ns3::dcfp::RerrHeader::RemoveUnDestination(std::pair<ns3::Ipv4Address, unsigned int> & un) [member function]
    cls.add_method('RemoveUnDestination', 
                   'bool', 
                   [param('std::pair< ns3::Ipv4Address, unsigned int > &', 'un')])
    ## dcfp-packet.h (module 'dcfp'): void ns3::dcfp::RerrHeader::Serialize(ns3::Buffer::Iterator i) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'i')], 
                   is_const=True, is_virtual=True)
    ## dcfp-packet.h (module 'dcfp'): void ns3::dcfp::RerrHeader::SetNoDelete(bool f) [member function]
    cls.add_method('SetNoDelete', 
                   'void', 
                   [param('bool', 'f')])
    return

def register_Ns3dcfpRoutingProtocol_methods(root_module, cls):
    ## dcfp-routing-protocol.h (module 'dcfp'): ns3::dcfp::RoutingProtocol::RoutingProtocol(ns3::dcfp::RoutingProtocol const & arg0) [constructor]
    cls.add_constructor([param('ns3::dcfp::RoutingProtocol const &', 'arg0')])
    ## dcfp-routing-protocol.h (module 'dcfp'): ns3::dcfp::RoutingProtocol::RoutingProtocol() [constructor]
    cls.add_constructor([])
    ## dcfp-routing-protocol.h (module 'dcfp'): int64_t ns3::dcfp::RoutingProtocol::AssignStreams(int64_t stream) [member function]
    cls.add_method('AssignStreams', 
                   'int64_t', 
                   [param('int64_t', 'stream')])
    ## dcfp-routing-protocol.h (module 'dcfp'): void ns3::dcfp::RoutingProtocol::DoDispose() [member function]
    cls.add_method('DoDispose', 
                   'void', 
                   [], 
                   is_virtual=True)
    ## dcfp-routing-protocol.h (module 'dcfp'): bool ns3::dcfp::RoutingProtocol::GetBroadcastEnable() const [member function]
    cls.add_method('GetBroadcastEnable', 
                   'bool', 
                   [], 
                   is_const=True)
    ## dcfp-routing-protocol.h (module 'dcfp'): bool ns3::dcfp::RoutingProtocol::GetDestinationOnlyFlag() const [member function]
    cls.add_method('GetDestinationOnlyFlag', 
                   'bool', 
                   [], 
                   is_const=True)
    ## dcfp-routing-protocol.h (module 'dcfp'): bool ns3::dcfp::RoutingProtocol::GetGratuitousReplyFlag() const [member function]
    cls.add_method('GetGratuitousReplyFlag', 
                   'bool', 
                   [], 
                   is_const=True)
    ## dcfp-routing-protocol.h (module 'dcfp'): bool ns3::dcfp::RoutingProtocol::GetHelloEnable() const [member function]
    cls.add_method('GetHelloEnable', 
                   'bool', 
                   [], 
                   is_const=True)
    ## dcfp-routing-protocol.h (module 'dcfp'): uint32_t ns3::dcfp::RoutingProtocol::GetMaxQueueLen() const [member function]
    cls.add_method('GetMaxQueueLen', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## dcfp-routing-protocol.h (module 'dcfp'): ns3::Time ns3::dcfp::RoutingProtocol::GetMaxQueueTime() const [member function]
    cls.add_method('GetMaxQueueTime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## dcfp-routing-protocol.h (module 'dcfp'): static ns3::TypeId ns3::dcfp::RoutingProtocol::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## dcfp-routing-protocol.h (module 'dcfp'): void ns3::dcfp::RoutingProtocol::NotifyAddAddress(uint32_t interface, ns3::Ipv4InterfaceAddress address) [member function]
    cls.add_method('NotifyAddAddress', 
                   'void', 
                   [param('uint32_t', 'interface'), param('ns3::Ipv4InterfaceAddress', 'address')], 
                   is_virtual=True)
    ## dcfp-routing-protocol.h (module 'dcfp'): void ns3::dcfp::RoutingProtocol::NotifyInterfaceDown(uint32_t interface) [member function]
    cls.add_method('NotifyInterfaceDown', 
                   'void', 
                   [param('uint32_t', 'interface')], 
                   is_virtual=True)
    ## dcfp-routing-protocol.h (module 'dcfp'): void ns3::dcfp::RoutingProtocol::NotifyInterfaceUp(uint32_t interface) [member function]
    cls.add_method('NotifyInterfaceUp', 
                   'void', 
                   [param('uint32_t', 'interface')], 
                   is_virtual=True)
    ## dcfp-routing-protocol.h (module 'dcfp'): void ns3::dcfp::RoutingProtocol::NotifyRemoveAddress(uint32_t interface, ns3::Ipv4InterfaceAddress address) [member function]
    cls.add_method('NotifyRemoveAddress', 
                   'void', 
                   [param('uint32_t', 'interface'), param('ns3::Ipv4InterfaceAddress', 'address')], 
                   is_virtual=True)
    ## dcfp-routing-protocol.h (module 'dcfp'): void ns3::dcfp::RoutingProtocol::PrintRoutingTable(ns3::Ptr<ns3::OutputStreamWrapper> stream, ns3::Time::Unit unit=::ns3::Time::Unit::S) const [member function]
    cls.add_method('PrintRoutingTable', 
                   'void', 
                   [param('ns3::Ptr< ns3::OutputStreamWrapper >', 'stream'), param('ns3::Time::Unit', 'unit', default_value='::ns3::Time::Unit::S')], 
                   is_const=True, is_virtual=True)
    ## dcfp-routing-protocol.h (module 'dcfp'): bool ns3::dcfp::RoutingProtocol::RouteInput(ns3::Ptr<const ns3::Packet> p, ns3::Ipv4Header const & header, ns3::Ptr<const ns3::NetDevice> idev, ns3::Ipv4RoutingProtocol::UnicastForwardCallback ucb, ns3::Ipv4RoutingProtocol::MulticastForwardCallback mcb, ns3::Ipv4RoutingProtocol::LocalDeliverCallback lcb, ns3::Ipv4RoutingProtocol::ErrorCallback ecb) [member function]
    cls.add_method('RouteInput', 
                   'bool', 
                   [param('ns3::Ptr< ns3::Packet const >', 'p'), param('ns3::Ipv4Header const &', 'header'), param('ns3::Ptr< ns3::NetDevice const >', 'idev'), param('ns3::Callback< void, ns3::Ptr< ns3::Ipv4Route >, ns3::Ptr< ns3::Packet const >, ns3::Ipv4Header const &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'ucb'), param('ns3::Callback< void, ns3::Ptr< ns3::Ipv4MulticastRoute >, ns3::Ptr< ns3::Packet const >, ns3::Ipv4Header const &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'mcb'), param('ns3::Callback< void, ns3::Ptr< ns3::Packet const >, ns3::Ipv4Header const &, unsigned int, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'lcb'), param('ns3::Callback< void, ns3::Ptr< ns3::Packet const >, ns3::Ipv4Header const &, ns3::Socket::SocketErrno, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'ecb')], 
                   is_virtual=True)
    ## dcfp-routing-protocol.h (module 'dcfp'): ns3::Ptr<ns3::Ipv4Route> ns3::dcfp::RoutingProtocol::RouteOutput(ns3::Ptr<ns3::Packet> p, ns3::Ipv4Header const & header, ns3::Ptr<ns3::NetDevice> oif, ns3::Socket::SocketErrno & sockerr) [member function]
    cls.add_method('RouteOutput', 
                   'ns3::Ptr< ns3::Ipv4Route >', 
                   [param('ns3::Ptr< ns3::Packet >', 'p'), param('ns3::Ipv4Header const &', 'header'), param('ns3::Ptr< ns3::NetDevice >', 'oif'), param('ns3::Socket::SocketErrno &', 'sockerr')], 
                   is_virtual=True)
    ## dcfp-routing-protocol.h (module 'dcfp'): void ns3::dcfp::RoutingProtocol::SetBroadcastEnable(bool f) [member function]
    cls.add_method('SetBroadcastEnable', 
                   'void', 
                   [param('bool', 'f')])
    ## dcfp-routing-protocol.h (module 'dcfp'): void ns3::dcfp::RoutingProtocol::SetDestinationOnlyFlag(bool f) [member function]
    cls.add_method('SetDestinationOnlyFlag', 
                   'void', 
                   [param('bool', 'f')])
    ## dcfp-routing-protocol.h (module 'dcfp'): void ns3::dcfp::RoutingProtocol::SetGratuitousReplyFlag(bool f) [member function]
    cls.add_method('SetGratuitousReplyFlag', 
                   'void', 
                   [param('bool', 'f')])
    ## dcfp-routing-protocol.h (module 'dcfp'): void ns3::dcfp::RoutingProtocol::SetHelloEnable(bool f) [member function]
    cls.add_method('SetHelloEnable', 
                   'void', 
                   [param('bool', 'f')])
    ## dcfp-routing-protocol.h (module 'dcfp'): void ns3::dcfp::RoutingProtocol::SetIpv4(ns3::Ptr<ns3::Ipv4> ipv4) [member function]
    cls.add_method('SetIpv4', 
                   'void', 
                   [param('ns3::Ptr< ns3::Ipv4 >', 'ipv4')], 
                   is_virtual=True)
    ## dcfp-routing-protocol.h (module 'dcfp'): void ns3::dcfp::RoutingProtocol::SetMaxQueueLen(uint32_t len) [member function]
    cls.add_method('SetMaxQueueLen', 
                   'void', 
                   [param('uint32_t', 'len')])
    ## dcfp-routing-protocol.h (module 'dcfp'): void ns3::dcfp::RoutingProtocol::SetMaxQueueTime(ns3::Time t) [member function]
    cls.add_method('SetMaxQueueTime', 
                   'void', 
                   [param('ns3::Time', 't')])
    ## dcfp-routing-protocol.h (module 'dcfp'): ns3::dcfp::RoutingProtocol::dcfp_PORT [variable]
    cls.add_static_attribute('dcfp_PORT', 'uint32_t const', is_const=True)
    ## dcfp-routing-protocol.h (module 'dcfp'): void ns3::dcfp::RoutingProtocol::DoInitialize() [member function]
    cls.add_method('DoInitialize', 
                   'void', 
                   [], 
                   visibility='protected', is_virtual=True)
...
def register_Ns3dcfpRoutingTable_methods(root_module, cls):
    ## dcfp-rtable.h (module 'dcfp'): ns3::dcfp::RoutingTable::RoutingTable(ns3::dcfp::RoutingTable const & arg0) [constructor]
    cls.add_constructor([param('ns3::dcfp::RoutingTable const &', 'arg0')])
    ## dcfp-rtable.h (module 'dcfp'): ns3::dcfp::RoutingTable::RoutingTable(ns3::Time t) [constructor]
    cls.add_constructor([param('ns3::Time', 't')])
    ## dcfp-rtable.h (module 'dcfp'): bool ns3::dcfp::RoutingTable::AddRoute(ns3::dcfp::RoutingTableEntry & r) [member function]
    cls.add_method('AddRoute', 
                   'bool', 
                   [param('ns3::dcfp::RoutingTableEntry &', 'r')])
    ## dcfp-rtable.h (module 'dcfp'): void ns3::dcfp::RoutingTable::Clear() [member function]
    cls.add_method('Clear', 
                   'void', 
                   [])
    ## dcfp-rtable.h (module 'dcfp'): void ns3::dcfp::RoutingTable::DeleteAllRoutesFromInterface(ns3::Ipv4InterfaceAddress iface) [member function]
    cls.add_method('DeleteAllRoutesFromInterface', 
                   'void', 
                   [param('ns3::Ipv4InterfaceAddress', 'iface')])
    ## dcfp-rtable.h (module 'dcfp'): bool ns3::dcfp::RoutingTable::DeleteRoute(ns3::Ipv4Address dst) [member function]
    cls.add_method('DeleteRoute', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'dst')])
    ## dcfp-rtable.h (module 'dcfp'): ns3::Time ns3::dcfp::RoutingTable::GetBadLinkLifetime() const [member function]
    cls.add_method('GetBadLinkLifetime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## dcfp-rtable.h (module 'dcfp'): void ns3::dcfp::RoutingTable::GetListOfDestinationWithNextHop(ns3::Ipv4Address nextHop, std::map<ns3::Ipv4Address, unsigned int, std::less<ns3::Ipv4Address>, std::allocator<std::pair<const ns3::Ipv4Address, unsigned int> > > & unreachable) [member function]
    ...
    ## dcfp-rtable.h (module 'dcfp'): void ns3::dcfp::RoutingTable::InvalidateRoutesWithDst(std::map<ns3::Ipv4Address, unsigned int, std::less<ns3::Ipv4Address>, std::allocator<std::pair<const ns3::Ipv4Address, unsigned int> > > const & unreachable) [member function]
    cls.add_method('InvalidateRoutesWithDst', 
                   'void', 
                   [param('std::map< ns3::Ipv4Address, unsigned int > const &', 'unreachable')])
    ## dcfp-rtable.h (module 'dcfp'): bool ns3::dcfp::RoutingTable::LookupRoute(ns3::Ipv4Address dst, ns3::dcfp::RoutingTableEntry & rt) [member function]
    cls.add_method('LookupRoute', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'dst'), param('ns3::dcfp::RoutingTableEntry &', 'rt')])
    ## dcfp-rtable.h (module 'dcfp'): bool ns3::dcfp::RoutingTable::LookupValidRoute(ns3::Ipv4Address dst, ns3::dcfp::RoutingTableEntry & rt) [member function]
    cls.add_method('LookupValidRoute', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'dst'), param('ns3::dcfp::RoutingTableEntry &', 'rt')])
    ## dcfp-rtable.h (module 'dcfp'): bool ns3::dcfp::RoutingTable::MarkLinkAsUnidirectional(ns3::Ipv4Address neighbor, ns3::Time blacklistTimeout) [member function]
    cls.add_method('MarkLinkAsUnidirectional', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'neighbor'), param('ns3::Time', 'blacklistTimeout')])
    ## dcfp-rtable.h (module 'dcfp'): void ns3::dcfp::RoutingTable::Print(ns3::Ptr<ns3::OutputStreamWrapper> stream) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('ns3::Ptr< ns3::OutputStreamWrapper >', 'stream')], 
                   is_const=True)
    ## dcfp-rtable.h (module 'dcfp'): void ns3::dcfp::RoutingTable::Purge() [member function]
    cls.add_method('Purge', 
                   'void', 
                   [])
    ## dcfp-rtable.h (module 'dcfp'): void ns3::dcfp::RoutingTable::SetBadLinkLifetime(ns3::Time t) [member function]
    cls.add_method('SetBadLinkLifetime', 
                   'void', 
                   [param('ns3::Time', 't')])
    ## dcfp-rtable.h (module 'dcfp'): bool ns3::dcfp::RoutingTable::SetEntryState(ns3::Ipv4Address dst, ns3::dcfp::RouteFlags state) [member function]
    cls.add_method('SetEntryState', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'dst'), param('ns3::dcfp::RouteFlags', 'state')])
    ## dcfp-rtable.h (module 'dcfp'): bool ns3::dcfp::RoutingTable::Update(ns3::dcfp::RoutingTableEntry & rt) [member function]
    cls.add_method('Update', 
                   'bool', 
                   [param('ns3::dcfp::RoutingTableEntry &', 'rt')])
    return

def register_Ns3dcfpRoutingTableEntry_methods(root_module, cls):
    ## dcfp-rtable.h (module 'dcfp'): ns3::dcfp::RoutingTableEntry::RoutingTableEntry(ns3::dcfp::RoutingTableEntry const & arg0) [constructor]
    cls.add_constructor([param('ns3::dcfp::RoutingTableEntry const &', 'arg0')])
    ## dcfp-rtable.h (module 'dcfp'): ns3::dcfp::RoutingTableEntry::RoutingTableEntry(ns3::Ptr<ns3::NetDevice> dev=0, ns3::Ipv4Address dst=ns3::Ipv4Address(), bool vSeqNo=false, uint32_t seqNo=0, ns3::Ipv4InterfaceAddress iface=ns3::Ipv4InterfaceAddress(), uint16_t hops=0, ns3::Ipv4Address nextHop=ns3::Ipv4Address(), ns3::Time lifetime=ns3::Simulator::Now()) [constructor]
    ...
    ## dcfp-rtable.h (module 'dcfp'): void ns3::dcfp::RoutingTableEntry::DeleteAllPrecursors() [member function]
    cls.add_method('DeleteAllPrecursors', 
                   'void', 
                   [])
    ## dcfp-rtable.h (module 'dcfp'): bool ns3::dcfp::RoutingTableEntry::DeletePrecursor(ns3::Ipv4Address id) [member function]
    cls.add_method('DeletePrecursor', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'id')])
    ## dcfp-rtable.h (module 'dcfp'): ns3::Time ns3::dcfp::RoutingTableEntry::GetBlacklistTimeout() const [member function]
    cls.add_method('GetBlacklistTimeout', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## dcfp-rtable.h (module 'dcfp'): ns3::Ipv4Address ns3::dcfp::RoutingTableEntry::GetDestination() const [member function]
    cls.add_method('GetDestination', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## dcfp-rtable.h (module 'dcfp'): ns3::dcfp::RouteFlags ns3::dcfp::RoutingTableEntry::GetFlag() const [member function]
    cls.add_method('GetFlag', 
                   'ns3::dcfp::RouteFlags', 
                   [], 
                   is_const=True)
    ## dcfp-rtable.h (module 'dcfp'): uint16_t ns3::dcfp::RoutingTableEntry::GetHop() const [member function]
    cls.add_method('GetHop', 
                   'uint16_t', 
                   [], 
                   is_const=True)
    ## dcfp-rtable.h (module 'dcfp'): ns3::Ipv4InterfaceAddress ns3::dcfp::RoutingTableEntry::GetInterface() const [member function]
    cls.add_method('GetInterface', 
                   'ns3::Ipv4InterfaceAddress', 
                   [], 
                   is_const=True)
    ## dcfp-rtable.h (module 'dcfp'): ns3::Time ns3::dcfp::RoutingTableEntry::GetLifeTime() const [member function]
    cls.add_method('GetLifeTime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## dcfp-rtable.h (module 'dcfp'): ns3::Ipv4Address ns3::dcfp::RoutingTableEntry::GetNextHop() const [member function]
    cls.add_method('GetNextHop', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## dcfp-rtable.h (module 'dcfp'): ns3::Ptr<ns3::NetDevice> ns3::dcfp::RoutingTableEntry::GetOutputDevice() const [member function]
    cls.add_method('GetOutputDevice', 
                   'ns3::Ptr< ns3::NetDevice >', 
                   [], 
                   is_const=True)
    ## dcfp-rtable.h (module 'dcfp'): void ns3::dcfp::RoutingTableEntry::GetPrecursors(std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > & prec) const [member function]
    cls.add_method('GetPrecursors', 
                   'void', 
                   [param('std::vector< ns3::Ipv4Address > &', 'prec')], 
                   is_const=True)
    ## dcfp-rtable.h (module 'dcfp'): ns3::Ptr<ns3::Ipv4Route> ns3::dcfp::RoutingTableEntry::GetRoute() const [member function]
    cls.add_method('GetRoute', 
                   'ns3::Ptr< ns3::Ipv4Route >', 
                   [], 
                   is_const=True)
    ## dcfp-rtable.h (module 'dcfp'): uint8_t ns3::dcfp::RoutingTableEntry::GetRreqCnt() const [member function]
    cls.add_method('GetRreqCnt', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## dcfp-rtable.h (module 'dcfp'): uint32_t ns3::dcfp::RoutingTableEntry::GetSeqNo() const [member function]
    cls.add_method('GetSeqNo', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## dcfp-rtable.h (module 'dcfp'): bool ns3::dcfp::RoutingTableEntry::GetValidSeqNo() const [member function]
    cls.add_method('GetValidSeqNo', 
                   'bool', 
                   [], 
                   is_const=True)
    ## dcfp-rtable.h (module 'dcfp'): void ns3::dcfp::RoutingTableEntry::IncrementRreqCnt() [member function]
    cls.add_method('IncrementRreqCnt', 
                   'void', 
                   [])
    ## dcfp-rtable.h (module 'dcfp'): bool ns3::dcfp::RoutingTableEntry::InsertPrecursor(ns3::Ipv4Address id) [member function]
    cls.add_method('InsertPrecursor', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'id')])
    ## dcfp-rtable.h (module 'dcfp'): void ns3::dcfp::RoutingTableEntry::Invalidate(ns3::Time badLinkLifetime) [member function]
    cls.add_method('Invalidate', 
                   'void', 
                   [param('ns3::Time', 'badLinkLifetime')])
    ## dcfp-rtable.h (module 'dcfp'): bool ns3::dcfp::RoutingTableEntry::IsPrecursorListEmpty() const [member function]
    cls.add_method('IsPrecursorListEmpty', 
                   'bool', 
                   [], 
                   is_const=True)
    ## dcfp-rtable.h (module 'dcfp'): bool ns3::dcfp::RoutingTableEntry::IsUnidirectional() const [member function]
    cls.add_method('IsUnidirectional', 
                   'bool', 
                   [], 
                   is_const=True)
    ## dcfp-rtable.h (module 'dcfp'): bool ns3::dcfp::RoutingTableEntry::LookupPrecursor(ns3::Ipv4Address id) [member function]
    cls.add_method('LookupPrecursor', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'id')])
    ## dcfp-rtable.h (module 'dcfp'): void ns3::dcfp::RoutingTableEntry::Print(ns3::Ptr<ns3::OutputStreamWrapper> stream) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('ns3::Ptr< ns3::OutputStreamWrapper >', 'stream')], 
                   is_const=True)
    ## dcfp-rtable.h (module 'dcfp'): void ns3::dcfp::RoutingTableEntry::SetBlacklistTimeout(ns3::Time t) [member function]
    cls.add_method('SetBlacklistTimeout', 
                   'void', 
                   [param('ns3::Time', 't')])
    ## dcfp-rtable.h (module 'dcfp'): void ns3::dcfp::RoutingTableEntry::SetFlag(ns3::dcfp::RouteFlags flag) [member function]
    cls.add_method('SetFlag', 
                   'void', 
                   [param('ns3::dcfp::RouteFlags', 'flag')])
    ## dcfp-rtable.h (module 'dcfp'): void ns3::dcfp::RoutingTableEntry::SetHop(uint16_t hop) [member function]
    cls.add_method('SetHop', 
                   'void', 
                   [param('uint16_t', 'hop')])
    ## dcfp-rtable.h (module 'dcfp'): void ns3::dcfp::RoutingTableEntry::SetInterface(ns3::Ipv4InterfaceAddress iface) [member function]
    cls.add_method('SetInterface', 
                   'void', 
                   [param('ns3::Ipv4InterfaceAddress', 'iface')])
    ## dcfp-rtable.h (module 'dcfp'): void ns3::dcfp::RoutingTableEntry::SetLifeTime(ns3::Time lt) [member function]
    cls.add_method('SetLifeTime', 
                   'void', 
                   [param('ns3::Time', 'lt')])
    ## dcfp-rtable.h (module 'dcfp'): void ns3::dcfp::RoutingTableEntry::SetNextHop(ns3::Ipv4Address nextHop) [member function]
    cls.add_method('SetNextHop', 
                   'void', 
                   [param('ns3::Ipv4Address', 'nextHop')])
    ## dcfp-rtable.h (module 'dcfp'): void ns3::dcfp::RoutingTableEntry::SetOutputDevice(ns3::Ptr<ns3::NetDevice> dev) [member function]
    cls.add_method('SetOutputDevice', 
                   'void', 
                   [param('ns3::Ptr< ns3::NetDevice >', 'dev')])
    ## dcfp-rtable.h (module 'dcfp'): void ns3::dcfp::RoutingTableEntry::SetRoute(ns3::Ptr<ns3::Ipv4Route> r) [member function]
    cls.add_method('SetRoute', 
                   'void', 
                   [param('ns3::Ptr< ns3::Ipv4Route >', 'r')])
    ## dcfp-rtable.h (module 'dcfp'): void ns3::dcfp::RoutingTableEntry::SetRreqCnt(uint8_t n) [member function]
    cls.add_method('SetRreqCnt', 
                   'void', 
                   [param('uint8_t', 'n')])
    ## dcfp-rtable.h (module 'dcfp'): void ns3::dcfp::RoutingTableEntry::SetSeqNo(uint32_t sn) [member function]
    cls.add_method('SetSeqNo', 
                   'void', 
                   [param('uint32_t', 'sn')])
    ## dcfp-rtable.h (module 'dcfp'): void ns3::dcfp::RoutingTableEntry::SetUnidirectional(bool u) [member function]
    cls.add_method('SetUnidirectional', 
                   'void', 
                   [param('bool', 'u')])
    ## dcfp-rtable.h (module 'dcfp'): void ns3::dcfp::RoutingTableEntry::SetValidSeqNo(bool s) [member function]
    cls.add_method('SetValidSeqNo', 
                   'void', 
                   [param('bool', 's')])
    ## dcfp-rtable.h (module 'dcfp'): ns3::dcfp::RoutingTableEntry::m_ackTimer [variable]
    cls.add_instance_attribute('m_ackTimer', 'ns3::Timer', is_const=False)
    return

def register_Ns3dcfpRrepAckHeader_methods(root_module, cls):
    cls.add_output_stream_operator()
    cls.add_binary_comparison_operator('==')
    ## dcfp-packet.h (module 'dcfp'): ns3::dcfp::RrepAckHeader::RrepAckHeader(ns3::dcfp::RrepAckHeader const & arg0) [constructor]
    cls.add_constructor([param('ns3::dcfp::RrepAckHeader const &', 'arg0')])
    ## dcfp-packet.h (module 'dcfp'): ns3::dcfp::RrepAckHeader::RrepAckHeader() [constructor]
    cls.add_constructor([])
    ## dcfp-packet.h (module 'dcfp'): uint32_t ns3::dcfp::RrepAckHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## dcfp-packet.h (module 'dcfp'): ns3::TypeId ns3::dcfp::RrepAckHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## dcfp-packet.h (module 'dcfp'): uint32_t ns3::dcfp::RrepAckHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## dcfp-packet.h (module 'dcfp'): static ns3::TypeId ns3::dcfp::RrepAckHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## dcfp-packet.h (module 'dcfp'): void ns3::dcfp::RrepAckHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## dcfp-packet.h (module 'dcfp'): void ns3::dcfp::RrepAckHeader::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
...
def register_Ns3dcfpRrepHeader_methods(root_module, cls):
    cls.add_output_stream_operator()
    cls.add_binary_comparison_operator('==')
    ## dcfp-packet.h (module 'dcfp'): ns3::dcfp::RrepHeader::RrepHeader(ns3::dcfp::RrepHeader const & arg0) [constructor]
    cls.add_constructor([param('ns3::dcfp::RrepHeader const &', 'arg0')])
    ## dcfp-packet.h (module 'dcfp'): ns3::dcfp::RrepHeader::RrepHeader(uint8_t prefixSize=0, uint8_t hopCount=0, ns3::Ipv4Address dst=ns3::Ipv4Address(), uint32_t dstSeqNo=0, ns3::Ipv4Address origin=ns3::Ipv4Address(), ns3::Time lifetime=ns3::MilliSeconds(0)) [constructor]
    ...
    ## dcfp-packet.h (module 'dcfp'): uint32_t ns3::dcfp::RrepHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## dcfp-packet.h (module 'dcfp'): bool ns3::dcfp::RrepHeader::GetAckRequired() const [member function]
    cls.add_method('GetAckRequired', 
                   'bool', 
                   [], 
                   is_const=True)
    ## dcfp-packet.h (module 'dcfp'): ns3::Ipv4Address ns3::dcfp::RrepHeader::GetDst() const [member function]
    cls.add_method('GetDst', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## dcfp-packet.h (module 'dcfp'): uint32_t ns3::dcfp::RrepHeader::GetDstSeqno() const [member function]
    cls.add_method('GetDstSeqno', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## dcfp-packet.h (module 'dcfp'): uint8_t ns3::dcfp::RrepHeader::GetHopCount() const [member function]
    cls.add_method('GetHopCount', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## dcfp-packet.h (module 'dcfp'): ns3::TypeId ns3::dcfp::RrepHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## dcfp-packet.h (module 'dcfp'): ns3::Time ns3::dcfp::RrepHeader::GetLifeTime() const [member function]
    cls.add_method('GetLifeTime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## dcfp-packet.h (module 'dcfp'): ns3::Ipv4Address ns3::dcfp::RrepHeader::GetOrigin() const [member function]
    cls.add_method('GetOrigin', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## dcfp-packet.h (module 'dcfp'): uint8_t ns3::dcfp::RrepHeader::GetPrefixSize() const [member function]
    cls.add_method('GetPrefixSize', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## dcfp-packet.h (module 'dcfp'): uint32_t ns3::dcfp::RrepHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## dcfp-packet.h (module 'dcfp'): static ns3::TypeId ns3::dcfp::RrepHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## dcfp-packet.h (module 'dcfp'): void ns3::dcfp::RrepHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## dcfp-packet.h (module 'dcfp'): void ns3::dcfp::RrepHeader::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
    ## dcfp-packet.h (module 'dcfp'): void ns3::dcfp::RrepHeader::SetAckRequired(bool f) [member function]
    cls.add_method('SetAckRequired', 
                   'void', 
                   [param('bool', 'f')])
    ## dcfp-packet.h (module 'dcfp'): void ns3::dcfp::RrepHeader::SetDst(ns3::Ipv4Address a) [member function]
    cls.add_method('SetDst', 
                   'void', 
                   [param('ns3::Ipv4Address', 'a')])
    ## dcfp-packet.h (module 'dcfp'): void ns3::dcfp::RrepHeader::SetDstSeqno(uint32_t s) [member function]
    cls.add_method('SetDstSeqno', 
                   'void', 
                   [param('uint32_t', 's')])
    ## dcfp-packet.h (module 'dcfp'): void ns3::dcfp::RrepHeader::SetHello(ns3::Ipv4Address src, uint32_t srcSeqNo, ns3::Time lifetime) [member function]
    cls.add_method('SetHello', 
                   'void', 
                   [param('ns3::Ipv4Address', 'src'), param('uint32_t', 'srcSeqNo'), param('ns3::Time', 'lifetime')])
    ## dcfp-packet.h (module 'dcfp'): void ns3::dcfp::RrepHeader::SetHopCount(uint8_t count) [member function]
    cls.add_method('SetHopCount', 
                   'void', 
                   [param('uint8_t', 'count')])
    ## dcfp-packet.h (module 'dcfp'): void ns3::dcfp::RrepHeader::SetLifeTime(ns3::Time t) [member function]
    cls.add_method('SetLifeTime', 
                   'void', 
                   [param('ns3::Time', 't')])
    ## dcfp-packet.h (module 'dcfp'): void ns3::dcfp::RrepHeader::SetOrigin(ns3::Ipv4Address a) [member function]
    cls.add_method('SetOrigin', 
                   'void', 
                   [param('ns3::Ipv4Address', 'a')])
    ## dcfp-packet.h (module 'dcfp'): void ns3::dcfp::RrepHeader::SetPrefixSize(uint8_t sz) [member function]
    cls.add_method('SetPrefixSize', 
                   'void', 
                   [param('uint8_t', 'sz')])
    return

def register_Ns3dcfpRreqHeader_methods(root_module, cls):
    cls.add_output_stream_operator()
    cls.add_binary_comparison_operator('==')
    ## dcfp-packet.h (module 'dcfp'): ns3::dcfp::RreqHeader::RreqHeader(ns3::dcfp::RreqHeader const & arg0) [constructor]
    cls.add_constructor([param('ns3::dcfp::RreqHeader const &', 'arg0')])
    ## dcfp-packet.h (module 'dcfp'): ns3::dcfp::RreqHeader::RreqHeader(uint8_t flags=0, uint8_t reserved=0, uint8_t hopCount=0, uint32_t requestID=0, ns3::Ipv4Address dst=ns3::Ipv4Address(), uint32_t dstSeqNo=0, ns3::Ipv4Address origin=ns3::Ipv4Address(), uint32_t originSeqNo=0) [constructor]
    ...
    ## dcfp-packet.h (module 'dcfp'): uint32_t ns3::dcfp::RreqHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## dcfp-packet.h (module 'dcfp'): bool ns3::dcfp::RreqHeader::GetDestinationOnly() const [member function]
    cls.add_method('GetDestinationOnly', 
                   'bool', 
                   [], 
                   is_const=True)
    ## dcfp-packet.h (module 'dcfp'): ns3::Ipv4Address ns3::dcfp::RreqHeader::GetDst() const [member function]
    cls.add_method('GetDst', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## dcfp-packet.h (module 'dcfp'): uint32_t ns3::dcfp::RreqHeader::GetDstSeqno() const [member function]
    cls.add_method('GetDstSeqno', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## dcfp-packet.h (module 'dcfp'): bool ns3::dcfp::RreqHeader::GetGratuitousRrep() const [member function]
    cls.add_method('GetGratuitousRrep', 
                   'bool', 
                   [], 
                   is_const=True)
    ## dcfp-packet.h (module 'dcfp'): uint8_t ns3::dcfp::RreqHeader::GetHopCount() const [member function]
    cls.add_method('GetHopCount', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## dcfp-packet.h (module 'dcfp'): uint32_t ns3::dcfp::RreqHeader::GetId() const [member function]
    cls.add_method('GetId', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## dcfp-packet.h (module 'dcfp'): ns3::TypeId ns3::dcfp::RreqHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## dcfp-packet.h (module 'dcfp'): ns3::Ipv4Address ns3::dcfp::RreqHeader::GetOrigin() const [member function]
    cls.add_method('GetOrigin', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## dcfp-packet.h (module 'dcfp'): uint32_t ns3::dcfp::RreqHeader::GetOriginSeqno() const [member function]
    cls.add_method('GetOriginSeqno', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## dcfp-packet.h (module 'dcfp'): uint32_t ns3::dcfp::RreqHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## dcfp-packet.h (module 'dcfp'): static ns3::TypeId ns3::dcfp::RreqHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## dcfp-packet.h (module 'dcfp'): bool ns3::dcfp::RreqHeader::GetUnknownSeqno() const [member function]
    cls.add_method('GetUnknownSeqno', 
                   'bool', 
                   [], 
                   is_const=True)
    ## dcfp-packet.h (module 'dcfp'): void ns3::dcfp::RreqHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## dcfp-packet.h (module 'dcfp'): void ns3::dcfp::RreqHeader::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
    ## dcfp-packet.h (module 'dcfp'): void ns3::dcfp::RreqHeader::SetDestinationOnly(bool f) [member function]
    cls.add_method('SetDestinationOnly', 
                   'void', 
                   [param('bool', 'f')])
    ## dcfp-packet.h (module 'dcfp'): void ns3::dcfp::RreqHeader::SetDst(ns3::Ipv4Address a) [member function]
    cls.add_method('SetDst', 
                   'void', 
                   [param('ns3::Ipv4Address', 'a')])
    ## dcfp-packet.h (module 'dcfp'): void ns3::dcfp::RreqHeader::SetDstSeqno(uint32_t s) [member function]
    cls.add_method('SetDstSeqno', 
                   'void', 
                   [param('uint32_t', 's')])
    ## dcfp-packet.h (module 'dcfp'): void ns3::dcfp::RreqHeader::SetGratuitousRrep(bool f) [member function]
    cls.add_method('SetGratuitousRrep', 
                   'void', 
                   [param('bool', 'f')])
    ## dcfp-packet.h (module 'dcfp'): void ns3::dcfp::RreqHeader::SetHopCount(uint8_t count) [member function]
    cls.add_method('SetHopCount', 
                   'void', 
                   [param('uint8_t', 'count')])
    ## dcfp-packet.h (module 'dcfp'): void ns3::dcfp::RreqHeader::SetId(uint32_t id) [member function]
    cls.add_method('SetId', 
                   'void', 
                   [param('uint32_t', 'id')])
    ## dcfp-packet.h (module 'dcfp'): void ns3::dcfp::RreqHeader::SetOrigin(ns3::Ipv4Address a) [member function]
    cls.add_method('SetOrigin', 
                   'void', 
                   [param('ns3::Ipv4Address', 'a')])
    ## dcfp-packet.h (module 'dcfp'): void ns3::dcfp::RreqHeader::SetOriginSeqno(uint32_t s) [member function]
    cls.add_method('SetOriginSeqno', 
                   'void', 
                   [param('uint32_t', 's')])
    ## dcfp-packet.h (module 'dcfp'): void ns3::dcfp::RreqHeader::SetUnknownSeqno(bool f) [member function]
    cls.add_method('SetUnknownSeqno', 
                   'void', 
                   [param('bool', 'f')])
    return

def register_Ns3dcfpTypeHeader_methods(root_module, cls):
    cls.add_output_stream_operator()
    cls.add_binary_comparison_operator('==')
    ## dcfp-packet.h (module 'dcfp'): ns3::dcfp::TypeHeader::TypeHeader(ns3::dcfp::TypeHeader const & arg0) [constructor]
    cls.add_constructor([param('ns3::dcfp::TypeHeader const &', 'arg0')])
    ## dcfp-packet.h (module 'dcfp'): ns3::dcfp::TypeHeader::TypeHeader(ns3::dcfp::MessageType t=::ns3::dcfp::MessageType::dcfpTYPE_RREQ) [constructor]
    cls.add_constructor([param('ns3::dcfp::MessageType', 't', default_value='::ns3::dcfp::MessageType::dcfpTYPE_RREQ')])
    ## dcfp-packet.h (module 'dcfp'): uint32_t ns3::dcfp::TypeHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## dcfp-packet.h (module 'dcfp'): ns3::dcfp::MessageType ns3::dcfp::TypeHeader::Get() const [member function]
    cls.add_method('Get', 
                   'ns3::dcfp::MessageType', 
                   [], 
                   is_const=True)
    ## dcfp-packet.h (module 'dcfp'): ns3::TypeId ns3::dcfp::TypeHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## dcfp-packet.h (module 'dcfp'): uint32_t ns3::dcfp::TypeHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## dcfp-packet.h (module 'dcfp'): static ns3::TypeId ns3::dcfp::TypeHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## dcfp-packet.h (module 'dcfp'): bool ns3::dcfp::TypeHeader::IsValid() const [member function]
    cls.add_method('IsValid', 
                   'bool', 
                   [], 
                   is_const=True)
    ## dcfp-packet.h (module 'dcfp'): void ns3::dcfp::TypeHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## dcfp-packet.h (module 'dcfp'): void ns3::dcfp::TypeHeader::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
...
def register_functions(root_module):
    ...
    register_functions_ns3_dcfp(module.add_cpp_namespace('dcfp'), root_module)
    return
...
def register_functions_ns3_dcfp(module, root_module):
    return
