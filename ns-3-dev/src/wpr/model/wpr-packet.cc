...
{
  static TypeId tid = TypeId ("ns3::wpr::TypeHeader")
    .SetParent<Header> ()
    .SetGroupName ("wpr")
...
{
  static TypeId tid = TypeId ("ns3::wpr::RreqHeader")
    .SetParent<Header> ()
    .SetGroupName ("wpr")
...
{
  static TypeId tid = TypeId ("ns3::wpr::RrepHeader")
    .SetParent<Header> ()
    .SetGroupName ("wpr")
...
{
  static TypeId tid = TypeId ("ns3::wpr::RrepAckHeader")
    .SetParent<Header> ()
    .SetGroupName ("wpr")
...
{
  static TypeId tid = TypeId ("ns3::wpr::RerrHeader")
    .SetParent<Header> ()
    .SetGroupName ("wpr")
