...
enum MessageType
{
  wprTYPE_RREQ  = 1,   //!< wprTYPE_RREQ
  wprTYPE_RREP  = 2,   //!< wprTYPE_RREP
  wprTYPE_RERR  = 3,   //!< wprTYPE_RERR
  wprTYPE_RREP_ACK = 4 //!< wprTYPE_RREP_ACK
};
...
public:
  /**
   * constructor
   * \param t the wpr RREQ type
   */
  TypeHeader (MessageType t = wprTYPE_RREQ);
