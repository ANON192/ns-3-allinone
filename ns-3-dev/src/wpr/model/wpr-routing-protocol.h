 ...
 */
#ifndef wprROUTINGPROTOCOL_H
#define wprROUTINGPROTOCOL_H

#include "wpr-rtable.h"
#include "wpr-rqueue.h"
...
public:
  ...
  static const uint32_t wpr_PORT;
...
private:
  ...
  void Recvwpr (Ptr<Socket> socket);
  /// Receive RREQ
