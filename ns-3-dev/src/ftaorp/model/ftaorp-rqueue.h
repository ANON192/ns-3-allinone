 ...
 */
#ifndef ftaorp_RQUEUE_H
#define ftaorp_RQUEUE_H
...
/**
 * \ingroup ftaorp
 * \brief ftaorp route request queue
 *
 * Since ftaorp is an on demand routing we queue requests while looking for route.
 */
class RequestQueue
{
public:
