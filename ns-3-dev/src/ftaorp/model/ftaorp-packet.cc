...
{
  static TypeId tid = TypeId ("ns3::ftaorp::TypeHeader")
    .SetParent<Header> ()
    .SetGroupName ("ftaorp")
...
{
  static TypeId tid = TypeId ("ns3::ftaorp::RreqHeader")
    .SetParent<Header> ()
    .SetGroupName ("ftaorp")
...
{
  static TypeId tid = TypeId ("ns3::ftaorp::RrepHeader")
    .SetParent<Header> ()
    .SetGroupName ("ftaorp")
...
{
  static TypeId tid = TypeId ("ns3::ftaorp::RrepAckHeader")
    .SetParent<Header> ()
    .SetGroupName ("ftaorp")
...
{
  static TypeId tid = TypeId ("ns3::ftaorp::RerrHeader")
    .SetParent<Header> ()
    .SetGroupName ("ftaorp")
