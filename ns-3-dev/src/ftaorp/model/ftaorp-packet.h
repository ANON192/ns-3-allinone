 ...
 */
#ifndef ftaorpPACKET_H
#define ftaorpPACKET_H
...
enum MessageType
{
  ftaorpTYPE_RREQ  = 1,   //!< ftaorpTYPE_RREQ
  ftaorpTYPE_RREP  = 2,   //!< ftaorpTYPE_RREP
  ftaorpTYPE_RERR  = 3,   //!< ftaorpTYPE_RERR
  ftaorpTYPE_RREP_ACK = 4 //!< ftaorpTYPE_RREP_ACK
};
...
public:
  /**
   * constructor
   * \param t the ftaorp RREQ type
   */
  TypeHeader (MessageType t = ftaorpTYPE_RREQ);
