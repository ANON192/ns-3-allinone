 ...
 *
 * Based on
 *      NS-2 mprp model developed by the CMU/MONARCH group and optimized and
 *      tuned by Samir Das and Mahesh Marina, University of Cincinnati;
 *
 *      mprp-UU implementation by Erik Nordström of Uppsala University
 *      http://core.it.uu.se/core/index.php/mprp-UU
 *
 * Authors: Elena Buchatskaia <borovkovaes@iitp.ru>
 *          Pavel Boyko <boyko@iitp.ru>
 */
#ifndef MPRPROUTINGPROTOCOL_H
#define MPRPROUTINGPROTOCOL_H

#include "mprp-rtable.h"
#include "mprp-rqueue.h"
#include "mprp-packet.h"
#include "mprp-neighbor.h"
#include "mprp-dpd.h"
#include "ns3/node.h"
...
public:
  ...
  static const uint32_t MPRP_PORT;
  static uint32_t m_RoutingPacketCount;
  /// constructor
  RoutingProtocol ();
   ...
   */
  void PrintIface();
  void PrintRoute(Ptr<Ipv4Route> rt)
  {
    std::cout<<" dst: " <<rt->GetDestination()<<
    " src: "<< rt->GetSource()<<
    " GW: "<<rt->GetGateway();
  }
  ...
  void IncRoutingPacketCount()
  {
    m_RoutingPacketCount++;
  }
  static uint32_t GetRoutingPacketCounts()
  {
    return(m_RoutingPacketCount);
  }
  /**
...
private:
  ...
  void RecvMprp (Ptr<Socket> socket);
  /// Receive RREQ
  ...
  void SendReply (RreqHeader const & rreqHeader, RoutingTableEntry const & toOrigin, RouteItem & toNext);
  void SendReplyAck (RrepHeader const & rrepHeader, RoutingTableEntry const & toOrigin, RouteItem & toNext);
