...
enum MessageType
{
  mprpTYPE_RREQ  = 1,   //!< mprpTYPE_RREQ
  mprpTYPE_RREP  = 2,   //!< mprpTYPE_RREP
  mprpTYPE_RERR  = 3,   //!< mprpTYPE_RERR
  mprpTYPE_RREP_ACK = 4 //!< mprpTYPE_RREP_ACK
};
...
public:
  /// c-tor
  TypeHeader (MessageType t = mprpTYPE_RREQ);
