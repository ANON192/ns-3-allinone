 ...
 * Authors: 
 */
#ifndef mprp_RQUEUE_H
#define mprp_RQUEUE_H
...
/**
 * \ingroup mprp
 * \brief mprp route request queue
 * 
 * Since mprp is an on demand routing we queue requests while looking for route.
 */
class RequestQueue
{
public:
