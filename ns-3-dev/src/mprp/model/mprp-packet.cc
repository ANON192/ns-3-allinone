...
{
  static TypeId tid = TypeId ("ns3::mprp::TypeHeader")
    .SetParent<Header> ()
...
{
  static TypeId tid = TypeId ("ns3::mprp::RreqHeader")
    .SetParent<Header> ()
...
RrepHeader::RrepHeader (uint8_t prefixSize, uint8_t hopCount, Ipv4Address dst, uint32_t dstSeqNo, Ipv4Address origin, uint32_t requestID, Ipv4Address firstHop, Time lifeTime) :
...
{
  static TypeId tid = TypeId ("ns3::mprp::RrepHeader")
    .SetParent<Header> ()
...
{
  static TypeId tid = TypeId ("ns3::mprp::RrepAckHeader")
    .SetParent<Header> ()
...
{
  static TypeId tid = TypeId ("ns3::mprp::RerrHeader")
    .SetParent<Header> ()
