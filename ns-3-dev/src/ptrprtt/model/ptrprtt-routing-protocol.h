 ...
 */
#ifndef ptrpROUTINGPROTOCOL_H
#define ptrpROUTINGPROTOCOL_H

#include "ptrp-rtable.h"
#include "ptrp-rqueue.h"
...
public:
  ...
  static const uint32_t ptrp_PORT;
...
private:
  ...
  void Recvptrp (Ptr<Socket> socket);
  /// Receive RREQ
